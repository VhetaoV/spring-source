 ...
 *
 * <p>
 *  支持{@link javalangRunnable}对象的JobFactory实现以及标准Quartz {@link orgquartzJob}实例
 * 
...
public class AdaptableJobFactory implements JobFactory {
	 ...
	 * <p>
	 *  将给定的作业对象调整到Quartz作业界面<p>默认实现支持直接Quartz作业以及Runnables,它们被包装在DelegatingJob中
	 * 
