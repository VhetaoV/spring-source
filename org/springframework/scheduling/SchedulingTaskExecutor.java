 ...
 *
 * <p>
 *  展开与潜在任务提交者相关的调度特征的{@link orgspringframeworkcoretaskTaskExecutor}扩展
 * 
 * <p>鼓励安排客户端提交{@link Runnable Runnables},以符合使用中{@code TaskExecutor}实施的公开偏好设置
 * 
 *  <p>注意：{@link SchedulingTaskExecutor}实现也是实现{@link orgspringframeworkcoretaskAsyncListenableTaskExecutor}
 * 接口。
 * 这不是必需的,因为它依赖于Spring 40的新的{@link orgspringframeworkutilconcurrentListenableFuture}接口,这将使得第三方派对执行器实现与Sp
 * ring 40和Spring 3x保持兼容。
 * 
