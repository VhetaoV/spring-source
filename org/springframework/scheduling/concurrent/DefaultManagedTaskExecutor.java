 ...
 *
 * <p>
 *  基于JNDI的变体{@link ConcurrentTaskExecutor},在Java EE 7环境中执行JSR-236的"java：comp / DefaultManagedExecutorSe
 * rvice"的默认查找。
 * 
 * 注意：这个类不是严格的基于JSR-236的;它可以与JNDI中可以找到的任何常规{@link javautilconcurrentExecutor}一起使用。
 * 实际适应{@link javaxenterpriseconcurrentManagedExecutorService}发生在基类{@link ConcurrentTaskExecutor}本身中。
 * 
 * 
...
public class DefaultManagedTaskExecutor extends ConcurrentTaskExecutor implements InitializingBean {
	 ...
	 * <p>
	 * 指定要委托的{@link javautilconcurrentExecutor}的JNDI名称,替换默认的JNDI名称"java：comp / DefaultManagedExecutorService
	 * "<p>这可以是完全限定的JNDI名称,也可以是相对于当前环境命名的JNDI名称如果"resourceRef"设置为"true"。
	 * 
