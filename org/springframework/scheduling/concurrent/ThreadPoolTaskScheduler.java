 ...
 *
 * <p>
 *  实现Spring的{@link TaskScheduler}接口,包含一个本机{@link javautilconcurrentScheduledThreadPoolExecutor}
 * 
 * 
...
public class ThreadPoolTaskScheduler extends ExecutorConfigurationSupport
	 ...
	 * <p>
	 * 设置ScheduledExecutorService的池大小默认值为1 <p> <b>可以在运行时修改此设置,例如通过JMX </b>
	 * 
	 */
	 ...
	 * <p><b>This setting can be modified at runtime, for example through JMX.</b>
	 * <p>
	 *  在{@link ScheduledThreadPoolExecutor}(JDK 7+)上设置取消取消模式<p>默认值为{@code false}如果设置为{@code true},目标执行程序将被切
	 * 换为取消取消模式(如果可能,否则为软回退)<p> <b>可以在运行时修改此设置,例如通过JMX </b>。
	 * 
	 */
	@UsesJava7
	 ...
	 * <p>
	 *  返回底层的ScheduledExecutorService进行本机访问
	 * 
	 * 
	 ...
	 * <p>
	 * 返回底层的ScheduledThreadPoolExecutor(如果有)
	 * 
	 * 
	 * @return the underlying ScheduledExecutorService (never {@code null})
	 * @throws IllegalStateException if the ThreadPoolTaskScheduler hasn't been initialized yet
	 ...
	 * <p>
	 *  返回当前池大小<p>需要底层{@link ScheduledThreadPoolExecutor}
	 * 
	 * 
	 ...
	 * <p>Requires an underlying {@link ScheduledThreadPoolExecutor}.
	 * <p>
	 *  返回取消取消模式的当前设置<p>需要底层{@link ScheduledThreadPoolExecutor}
	 * 
	 */
	@UsesJava7
	 ...
	 * <p>Requires an underlying {@link ScheduledThreadPoolExecutor}.
	 * <p>
	 *  返回当前活动线程的数量<p>需要底层{@link ScheduledThreadPoolExecutor}
	 * 
	 * @see #getScheduledThreadPoolExecutor()
