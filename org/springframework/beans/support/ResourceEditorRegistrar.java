 ...
 *
 * <p>
 * PropertyEditorRegistrar实现,使用资源编辑器填充给定的{@link orgspringframeworkbeansPropertyEditorRegistry}(通常用于{@link orgspringframeworkcontextApplicationContext}
 * 中的bean创建的{@link orgspringframeworkbeansBeanWrapper}),由{@link orgspringframeworkcontextsupportAbstractApplicationContext}
 * 。
 * 
 * 
...
public class ResourceEditorRegistrar implements PropertyEditorRegistrar {
	 ...
	 * <p>
	 * 使用以下资源编辑器填充给定的{@code注册表}：ResourceEditor,InputStreamEditor,InputSourceEditor,FileEditor,URLEditor,URIE
	 * ditor,ClassEditor,ClassArrayEditor <p>如果此注册器已配置了{@link ResourcePatternResolver},则ResourceArrayPropert
	 * yEditor将也注册了。
	 * 
	 * 
