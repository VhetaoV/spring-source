 ...
 *
 * <p>
 *  Spring的内部{@link PropertyDescriptor}实现的常用委托方法
 * 
 * 
 * @author Chris Beams
...
class PropertyDescriptorUtils {
	 ...
	 * <p>
	 *  请参阅{@link javabeansFeatureDescriptor}
	 * 
	 */
	 ...
	 * <p>
	 *  请参阅{@link javabeansPropertyDescriptor#findPropertyType}
	 * 
	 */
	 ...
	 * <p>
	 * 请参阅{@link javabeansIndexedPropertyDescriptor#findIndexedPropertyType}
	 * 
	 */
	 ...
	 * <p>
	 *  比较给定的{@code PropertyDescriptors}并返回{@code true},如果它们是等效的,即它们的读取方法,写入方法,属性类型,属性编辑器和标志是等效的
	 * 
