 ...
 *
 * <p>
 *  根据{@link PropertyAccessor}界面执行bean属性访问的类的实用方法
 * 
 * 
...
public abstract class PropertyAccessorUtils {
	 ...
	 * <p>
	 *  确定给定属性路径中的第一个嵌套属性分隔符,忽略键中的点(如"map [mykey]"))
	 * 
	 * 
	 * @param propertyPath the property path to check
	 ...
	 * given property path, ignoring dots in keys (like "map[my.key]").
	 * <p>
	 *  确定给定属性路径中的第一个(或最后)嵌套属性分隔符,忽略键中的点(如"map [mykey]")
	 * 
	 * 
	 * @param propertyPath the property path to check
	 ...
	 * <p>
	 *  确定给定属性路径的规范名称从地图键中删除周围的引号：<br> {@code map ['key']}  - > {@code map [key]} <br> {@code map ["key" ]} 
	 *  - > {@code map [key]}。
	 * 
	 * 
