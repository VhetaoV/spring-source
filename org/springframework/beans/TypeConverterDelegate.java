 ...
 *  用于将属性值转换为目标类型的内部助手类
 * 
 *  <p>在给定的{@link PropertyEditorRegistrySupport}实例上工作用作{@link BeanWrapperImpl}和{@link SimpleTypeConverter}
 * 的委托。
 * 
 * 
...
class TypeConverterDelegate {
	 ...
	 * <p>
	 * 为给定的编辑器注册表创建一个新的TypeConverterDelegate
	 * 
	 * 
	 ...
	 * <p>
	 *  使用给定的属性编辑器将值转换为必需的类型(如果需要,从String)
	 * 
	 * 
	 * @param oldValue the previous value, if available (may be {@code null})
	 * @param newValue the proposed new value
