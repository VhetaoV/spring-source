 ...
 *
 * <p>
 *  直接访问实例字段的{@link ConfigurablePropertyAccessor}实现允许直接绑定到字段而不是通过JavaBean设置器
 * 
 * <p>截至春季42,绝大多数{@link BeanWrapper}功能已合并到{@link AbstractPropertyAccessor}中,这意味着此处还支持属性遍历以及集合和地图访问
 * 
 *  <p> DirectFieldAccessor的"extractOldValueForEditor"设置的默认值为"true",因为一个字段总是可以读取而没有副作用
 * 
 * 
