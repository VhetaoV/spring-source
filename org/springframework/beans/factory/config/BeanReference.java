 ...
 *
 * <p>
 *  以抽象方式公开对bean名称的引用的接口此接口不一定意味着引用实际的bean实例;它只是表示一个bean的名称的逻辑引用
 * 
 * <p>作为通过任何类型的bean引用持有者实现的公共接口,例如{@link RuntimeBeanReference RuntimeBeanReference}和{@link RuntimeBeanNameReference RuntimeBeanNameReference}
 * 。
 * 
