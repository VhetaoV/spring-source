 ...
 *
 * <p>
 *  类型字符串值的持有者可以添加到bean定义中,以便为String值显式指定目标类型,例如对于集合元素
 * 
 * <p>这个持有者将只存储String值和目标类型实际的转换将由bean工厂执行
 * 
 * 
...
public class TypedStringValue implements BeanMetadataElement {
	 ...
	 * <p>
	 *  为给定的String值创建一个新的{@link TypedStringValue}
	 * 
	 * 
	 ...
	 * and target type.
	 * <p>
	 *  为给定的String值和目标类型创建一个新的{@link TypedStringValue}
	 * 
	 * 
	 * @param value the String value
	 ...
	 * <p>
	 *  设置String值<p>只需要操作一个已注册的值,例如在BeanFactoryPostProcessors中
	 * 
	 * 
	 ...
	 * for example in BeanFactoryPostProcessors.
	 * <p>
	 *  将类型设置为转换为<p>只需要处理注册的值,例如在BeanFactoryPostProcessors中
	 * 
	 * 
	 * @see PropertyPlaceholderConfigurer
	 */
	 ...
	 * <p>
	 * 确定要转换的类型,如果需要,从指定的类名解析它也将从其名称重新加载指定的类,并使用已解析的目标类型
	 * 
	 * 
