 ...
 *
 * <p>
 *  用于管理注入元数据的内部类不适用于直接用于应用程序
 * 
 * <p>由{@link AutowiredAnnotationBeanPostProcessor}使用,{@link orgspringframeworkcontextannotationCommonAnnotationBeanPostProcessor}
 * 和{@link orgspringframeworkormjpasupportPersistenceAnnotationBeanPostProcessor}。
 * 
 * 
...
public class InjectionMetadata {
	...
	public static abstract class InjectedElement {
		 ...
		 * <p>
		 *  这个或者{@link #getResourceToInject}需要被覆盖
		 * 
		 */
		 ...
		 * <p>
		 *  检查是否需要跳过此注入器的属性,因为已指定了显式的属性值。还标记受影响的属性为其他处理器处理以忽略它
		 * 
		 */
