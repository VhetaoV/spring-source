 ...
 *
 * <p>
 *  一个{@link orgspringframeworkbeansfactoryconfigBeanFactoryPostProcessor}实现,可以方便地注册自定义自动线路限定符类型
 * 
 * <pre class="code">
 * &lt; bean id ="customAutowireConfigurer"class ="orgspringframeworkbeansfactoryannotationCustomAutowir
 * eConfigurer"&gt; &lt; property name ="customQualifierTypes"&gt; &LT;集&gt; &LT;值GT; mypackageMyQualifi
 * er&LT; /值GT; &LT; /集&gt; &LT; /性&gt; &LT; /豆腐&GT; </PRE>。
 * 
 * @author Mark Fisher
