 ...
 *
 * <p>
 * {@link ComponentDefinition}的基本实现提供{@link #getDescription}的基本实现,该代码委托给{@link #getName}。
 * 还提供了{@link #toString}的基本实现,该代码委托{@link #getDescription}符合推荐的实施策略还提供返回空数组的{@link #getInnerBeanDefinitions}
 * 和{@link #getBeanReferences}的默认实现。
 * {@link ComponentDefinition}的基本实现提供{@link #getDescription}的基本实现,该代码委托给{@link #getName}。
 * 
 * 
 * @author Rob Harrop
