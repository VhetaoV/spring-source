 ...
 *
 * <p>
 * 通过{@link orgspringframeworkcoreioResourceLoader}(通常相对于ApplicationContext的资源库)解析实体引用的EntityResolver实现(
 * 如果适用)扩展{@link DelegatingEntityResolver}以提供DTD和XSD查找。
 * 
 *  <p>允许使用标准XML实体将XML片段包含在应用程序上下文定义中,例如将大型XML文件拆分为各种模块包含路径可以像往常一样相对于应用程序上下文的资源库,而不是相对于JVM工作目录(XML解析器的默认
 * 值)。
 * 
 * 
...
public class ResourceEntityResolver extends DelegatingEntityResolver {
	 ...
	 * <p>
	 * 注意：除相对路径之外,指定当前系统根目录(即JVM工作目录)中的文件的每个URL也将相对于应用程序上下文进行解释
	 * 
	 * 
