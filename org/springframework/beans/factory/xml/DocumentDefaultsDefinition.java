 ...
 *
 * <p>
 *  标准Spring XML bean定义文档中包含{@code <beans>}级别指定的默认值的简单JavaBean：{@code default-lazy-init},{@code default-autowire}
 * 等。
 * 
 * 
...
public class DocumentDefaultsDefinition implements DefaultsDefinition {
	 ...
	 * <p>
	 *  设置当前解析的文档的默认autowire-candidate模式。还可以接受以逗号分隔的模式列表
	 * 
	 */
	 ...
	 * <p>
	 * 返回当前解析的文档的默认autowire-candidate模式也可以返回逗号分隔的模式列表
	 * 
	 */
