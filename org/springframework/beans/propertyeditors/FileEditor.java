 ...
 *
 * <p>
 *  编辑器{@code javaioFile},直接从Spring资源位置填充File属性
 * 
 * <p>支持Spring样式的URL表示法：任何完全合格的标准URL("file：","http："等)和Spring的特殊"classpath："伪URL
 * 
 *  注意：</b>此编辑器的行为已在Spring 20中发生更改以前,它直接从文件名创建了一个File实例从Spring 20开始,它将标准的Spring资源位置作为输入;这与URLEditor和Inpu
 * tStreamEditor现在是一致的。
 * 
 *  <p> <b>注意：</b>在Spring 25中进行了以下修改如果指定了没有URL前缀或没有绝对路径的文件名,那么我们尝试使用标准的Res​​ourceLoader语义来定位文件如果文件是没有找到,
 * 
...
public class FileEditor extends PropertyEditorSupport {
	 ...
	 * <p>
	 * 创建一个新的FileEditor,使用下面的默认ResourceEditor
	 * 
	 * 
