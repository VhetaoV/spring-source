 ...
 *
 * <p>
 *  编辑器为{@code orgxmlsaxInputSource},从Spring资源位置字符串转换为SAX InputSource对象
 * 
...
public class InputSourceEditor extends PropertyEditorSupport {
	 ...
	 * <p>
	 *  创建一个新的InputSourceEditor,使用下面的默认ResourceEditor
	 * 
	 */
	 ...
	 * <p>
	 *  创建一个新的InputSourceEditor,使用给定的ResourceEditor下面
	 * 
