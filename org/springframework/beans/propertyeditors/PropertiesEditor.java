 ...
 *
 * <p>
 *  {@link Properties}对象的自定义{@link javabeansPropertyEditor}
 * 
 * 处理来自内容{@link String}到{@code属性}对象的转换还处理{@link Map}到{@code属性}转换,用于通过XML"地图"条目填充{@code属性}对象
 * 
 *  <p>所需格式在标准的{@code属性}文档中定义。每个属性必须在新行上
 * 
 * 
 * @author Rod Johnson
...
public class PropertiesEditor extends PropertyEditorSupport {
	 ...
	 * <p>
	 *  将{@link String}转换为{@link属性},将其视为属性内容
	 * 
	 */
	@Override
