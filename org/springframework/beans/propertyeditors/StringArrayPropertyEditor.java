 ...
 *
 * <p>
 *  String数组的自定义{@link javabeansPropertyEditor}
 * 
 *  <p>字符串必须采用CSV格式,具有可自定义的分隔符默认情况下,结果中的值将被修剪为空格
 * 
 * 
 * @author Rod Johnson
...
public class StringArrayPropertyEditor extends PropertyEditorSupport {
	 ...
	 * <p>
	 *  使用默认分隔符(逗号)创建一个新的StringArrayPropertyEditor <p>空文本(不含元素)将变为空数组
	 * 
	 */
	 ...
	 * <p>An empty text (without elements) will be turned into an empty array.
	 * <p>
	 *  使用给定的分隔符创建一个新的StringArrayPropertyEditor <p>空文本(不含元素)将变为空数组
	 * 
	 * 
	 ...
	 * Create a new StringArrayPropertyEditor with the given separator.
	 * <p>
	 *  用给定的分隔符创建一个新的StringArrayPropertyEditor
	 * 
	 * 
	 * @param separator the separator to use for splitting a {@link String}
