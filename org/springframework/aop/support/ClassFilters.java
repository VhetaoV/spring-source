 ...
 *
 * <p>
 *  用于撰写{@link ClassFilter ClassFilters}的静态实用程序方法
 * 
 * 
 * @author Rod Johnson
 * @author Rob Harrop
...
public abstract class ClassFilters {
	 ...
	 * <p>
	 *  匹配给定ClassFilter的<i> </i>(或两者)匹配的所有类
	 * 
	 * 
	 ...
	 * <p>
	 * 匹配给定ClassFilter的<i> </i>(或全部)匹配的所有类
	 * 
	 * 
