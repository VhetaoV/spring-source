 ...
 *
 * <p>
 *  用于撰写{@link MethodMatcher MethodMatchers}的静态实用程序方法
 * 
 * 可以静态评估MethodMatcher(基于方法和目标类),或者需要动态进一步评估(基于方法调用时的参数)
 * 
 * 
 * @author Rod Johnson
 * @author Rob Harrop
...
public abstract class MethodMatchers {
	 ...
	 * <p>
	 *  匹配给定MethodMatchers的<i> </i>(或两者)匹配的所有方法
	 * 
	 * 
	 ...
	 * <p>
	 *  匹配给定MethodMatchers的<i> </i>的所有方法都匹配
	 * 
	 * 
	 * @param mm1 the first MethodMatcher
	 * @param mm2 the second MethodMatcher
	 ...
	 * (if applicable).
	 * <p>
	 *  将给定的MethodMatcher应用于给定的方法,支持{@link orgspringframeworkaopIntroductionAwareMethodMatcher}(如果适用)
	 * 
	 * 
	 ...
	 * <p>
	 *  两个给定MethodMatchers的联合的MethodMatcher实现
	 * 
	 */
	 ...
	 * <p>
	 *  MethodMatcher实现两个给定MethodMatchers的联合,支持每个MethodMatcher关联的ClassFilter
	 * 
	 */
	@SuppressWarnings("serial")
	 ...
	 * <p>
	 * MethodMatcher实现两个给定MethodMatcher的交集
	 */
	@SuppressWarnings("serial")
