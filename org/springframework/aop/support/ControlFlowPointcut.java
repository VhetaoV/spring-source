 ...
 *
 * <p>
 *  点击和方法匹配器,用于简单的<b> cflow </b> -style切入点注意,评估这样的切入点比评估正常切入点慢10-15倍,但在某些情况下它们很有用
 * 
 * 
 * @author Rod Johnson
 * @author Rob Harrop
...
public class ControlFlowPointcut implements Pointcut, ClassFilter, MethodMatcher, Serializable {
	 ...
	 * <p>
	 *  构造一个新的切入点,匹配给定类中给定方法下面的所有调用如果方法名为null,则匹配该类下面的所有控制流
	 * 
	 * 
	 * @param clazz the clazz
