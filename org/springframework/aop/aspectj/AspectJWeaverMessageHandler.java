 ...
 *
 * <p>
 *  实现AspectJ的{@link IMessageHandler}接口,通过与常规的Spring消息相同的日志记录系统来路由AspectJ编织消息
 * 
 *  <p>传递选项
 * 
 * <p> <code class ="code">  -  XmessageHandlerClass：orgspringframeworkaopaspectjAspectJWeaverMessageHan
 * dler </code>。
 * 
