 ...
 *
 * <p>
 *  这个类封装了一些AspectJ内部知识,应该在将来的版本中被推回到AspectJ项目中
 * 
 * <p>它依赖于AspectJ中的实现特定知识来打破封装,并做了一些AspectJ未设计的事情：查询将执行的运行时测试的类型这里的代码应迁移到{@code ShadowMatchgetVariablesInvolvedInRuntimeTest()}
 * 或类似的手术。
 * 
 *  <p>请参阅<a href=\"https://bugseclipseorg/bugs/show_bugcgi?id=151593\"/>错误151593 </a>
 * 
 * 
...
class RuntimeTestWalker {
	 ...
	 * <p>
	 *  如果测试使用任何这个,target,at_this,at_target和at_annotation vars,那么它测试子类型敏感的vars
	 * 
	 */
	 ...
	 * <p>
	 *  检查目标(TYPE)种类是否残留请参阅SPR-3783了解更多详细信息
	 * 
	 */
	 ...
	 * <p>
	 *  检查(TYPE)种类是否残留请参阅SPR-2979了解更多详细信息
	 */
