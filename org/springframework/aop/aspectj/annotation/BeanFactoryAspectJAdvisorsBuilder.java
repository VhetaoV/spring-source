 ...
 *
 * <p>
 *  帮助从BeanFactory检索@AspectJ bean,并根据它们构建Spring Advisors,用于自动代理
 * 
 * 
...
public class BeanFactoryAspectJAdvisorsBuilder {
	 ...
	 * <p>
	 *  在当前bean工厂中查找AspectJ注释的方面bean,并返回到表示它们的Spring AOP Advisors的列表<p>为每个AspectJ建议方法创建一个Spring顾问
	 * 
	 * 
