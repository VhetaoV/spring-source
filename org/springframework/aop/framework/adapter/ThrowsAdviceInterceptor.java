 ...
 *  拦截器包装一个抛出后的建议
 * 
 *  <p> {@code ThrowsAdvice}实现方法参数上的处理程序方法的签名必须具有以下形式：<br>
 * 
 * {@code void afterThrowing([Method,args,target],ThrowableSubclass);}
 * 
 *  <p>只有最后一个参数是必需的
 ...
 *  <p>有效方法的一些例子是：
 * 
 *  public void afterThrowing(Exception ex)</pre> <pre class ="code"> public void afterThrowing(RemoteEx
 * ception)</pre> <pre class ="code"> public void afterThrowing(Method方法,Object [] args,Object target,Ex
 * 
 * @author Rod Johnson
...
public class ThrowsAdviceInterceptor implements MethodInterceptor, AfterAdvice {
	 ...
	 * <p>
	 * ception ex)</pre> <pre class ="code"> public void afterThrowing(Method method,Object [] args,Object t
	 * arget,ServletException ex)。
	 * 
	 *  <p>这是一个框架类,不需要直接由Spring用户使用
	 * 
	 * 
