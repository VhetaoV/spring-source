...
public interface AdvisorAdapterRegistry {
	 ...
	 * <p>
	 * 返回一个包装给定建议的顾问<p>如果默认情况下至少支持{@link orgaopallianceinterceptMethodInterceptor},{@link orgspringframeworkaopMethodBeforeAdvice}
	 * ,{@link orgspringframeworkaopAfterReturningAdvice},{@link orgspringframeworkaopThrowsAdvice}。
	 * 
	 * 
	 ...
	 * <p>
	 *  返回一组AOP联盟方法接受者,以允许在基于拦截的框架中使用给定的Advisor <p>不要担心与顾问关联的切入点(如果它是PointcutAdvisor)：只需返回拦截器
	 * 
	 * 
	 ...
	 * <p>
	 *  注册给定的AdvisorAdapter注意,没有必要为AOP联盟拦截器或Spring建议注册适配器：这些必须由AdvisorAdapterRegistry实现自动识别
	 * 
