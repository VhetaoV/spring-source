 ...
 *
 * <p>
 *  BeanPostProcessor在BeanFactory中使用{@link AdvisorAdapterRegistry}注册{@link AdvisorAdapter} bean(默认情况下为{@link GlobalAdvisorAdapterRegistry}
 * )。
 * 
 * <p>它的唯一要求是它需要在应用程序上下文中定义,而"非本地"Spring AdvisorAdapters需要被Spring AOP框架"认可"
 * 
