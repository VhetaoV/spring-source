 ...
 *
 * <p>
 *  通用自动代理创建者,根据检测到的每个bean的Advisors为特定的bean构建AOP代理
 * 
 * <p>子类必须实现抽象{@link #findCandidateAdvisors()}方法来返回适用于任何对象的顾问列表子类也可以覆盖继承的{@link #shouldSkip}方法,以排除某些对象的自
 * 动代理。
 * 
 *  <p>需要订购的顾问或建议应实施{@link orgspringframeworkcoreOrdered}界面此类按订单价值排序顾问不执行有序接口的顾问将被视为无序;它们将以未定义的顺序出现在顾问链的
 * 末尾。
 * 
 * 
 * @author Rod Johnson
...
public abstract class AbstractAdvisorAutoProxyCreator extends AbstractAutoProxyCreator {
	 ...
	 * <p>
	 * 返回具有给定名称的Advisor bean是否符合首选代理的资格
	 * 
	 * 
	 ...
	 * <p>
	 *  扩展挂钩,子类可以覆盖以注册额外的顾问,给定到目前为止获得的排序的顾问<p>默认实现为空<p>通常用于添加顾问,暴露一些后来的顾问所需的上下文信息
	 * 
	 * 
	 ...
	 * <p>
	 *  BeanFactoryAdvisorRetrievalHelper的子类委托给周围的AbstractAdvisorAutoProxyCreator设施
	 */
