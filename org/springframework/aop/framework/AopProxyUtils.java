 ...
 *
 * <p>
 *  AOP代理工厂的实用方法主要用于AOP框架内部使用
 * 
 * <p>请参阅{@link orgspringframeworkaopsupportAopUtils}以获取不依赖于AOP框架内部的通用AOP实用程序集合的集合
 * 
 * 
 * @author Rod Johnson
...
public abstract class AopProxyUtils {
	 ...
	 * <p>
	 *  确定给定bean实例的最终目标类,不仅遍历顶级代理,而且遍历任意数量的嵌套代理以及mdash;只要尽可能没有副作用,就是单身对象
	 * 
	 * 
	 ...
	 * <p>
	 *  确定给定AOP配置的完整代理接口代码<p>这将永远添加{@link Advised}界面,除非AdvisedSupport的{@link AdvisedSupport#setOpaque"opaque"}
	 * 标志始终添加{@link orgspringframeworkaopSpringProxy }标记界面。
	 * 
	 * 
	 ...
	 * <p>
	 *  检查给定AdvisedSupport对象后面的代理的相等性与AdvisedSupport对象的相等性相同：相当于接口,顾问和目标来源的相等性
	 * 
	 */
	 ...
	 * <p>
	 * 在给定的方法中将给定的参数适配到目标签名,如果需要的话：特别是如果给定的vararg参数数组与方法中声明的vararg参数的数组类型不匹配
	 * 
