 ...
 *
 * <p>
 *  用于创建作用域代理的实用程序类由ScopedProxyBeanDefinitionDecorator和ClassPathBeanDefinitionScanner使用
 * 
 * 
 * @author Mark Fisher
...
public abstract class ScopedProxyUtils {
	 ...
	 * <p>
	 * 为提供的目标bean生成作用域代理,使用内部名称注册目标bean,并在作用域代理上设置"targetBeanName"
	 * 
	 * 
	 ...
	 * <p>
	 *  指定{@code beanName}是否是引用范围限定代理中的目标bean的bean的名称
	 * 
	 * @since 4.1.4
	 */
