 ...
 *  方便的代理工厂bean用于作用域对象
 * 
 *  <p>使用此工厂bean创建的代理是线程安全的单例,可以注入到共享对象中,具有透明的作用域行为
 * 
 * <p>此类返回的代理实现了{@link ScopedObject}接口。目前允许从范围中删除相应的对象,在下一次访问的范围内无缝创建新实例
 * 
 *  <p>请注意,此工厂创建的代理默认为基于类的</i>代理。可以通过将"proxyTargetClass"属性切换为"false"来定制,
 * 
 * @author Rod Johnson
