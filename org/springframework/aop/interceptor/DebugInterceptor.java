 ...
 *
 * <p>
 *  可以在链中引入的AOP联盟{@code MethodInterceptor}来显示关于截取的调用记录器的详细信息
 * 
 * <p>记录方法输入和方法退出的完整调用详细信息,包括调用参数和调用计数这仅用于调试目的;使用{@code SimpleTraceInterceptor}或{@code CustomizableTraceInterceptor}
 * 进行纯追踪。
 * 
 * 
 * @author Rod Johnson
