 ...
 * 
 * <p> <b>注意：</b>与Spring 25的{@link orgspringframeworkcontextconfigSpringConfiguredBeanDefinitionParser}基
 * 本上是{@code <context：spring-configured />}标签的重复,镜像在这里与Spring 20的{@代码<aop：spring-configured />}标签(避免直接依赖
 * 上下文包)。
 * 
 * @author Rob Harrop
