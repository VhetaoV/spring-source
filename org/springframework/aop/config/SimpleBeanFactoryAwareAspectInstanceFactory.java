 ...
 *
 * <p>
 *  实现使用配置的bean名称从{@link orgspringframeworkbeansfactoryBeanFactory}定位方面的{@link AspectInstanceFactory}
 * 
 * 
 * @author Rob Harrop
...
public class SimpleBeanFactoryAwareAspectInstanceFactory implements AspectInstanceFactory, BeanFactoryAware {
	 ...
	 * <p>
	 * 设置aspect bean的名称这是调用{@link #getAspectInstance()}时返回的bean)
	 * 
	 */
	 ...
	 * <p>
	 *  从{@link BeanFactory}查找aspect bean并返回它
	 * 
