 ...
 * 
 * <p>为{@code <aop：config>}标签提供{@link orgspringframeworkbeansfactoryxmlBeanDefinitionParser} {@code config}
 * 标签可以包含嵌套的{@code pointcut},{@code advisor}和{@code aspect}标签。
 * 
 *  <p> {@code pointcut}标签允许使用简单的语法创建命名的{@link AspectJExpressionPointcut} bean：
 * <pre class="code">
 *  &lt; aop：pointcut id ="getNameCalls"表达式="执行(* * ITestBeangetName())"/&gt;
 * </pre>
 * 
 *  <p>使用{@code advisor}标签,您可以配置{@link orgspringframeworkaopAdvisor}并将其应用于您自己的所有相关bean {@link orgspringframeworkbeansfactoryBeanFactory}
 *  {@code advisor}标签支持在线和引用{@link orgspringframeworkaopPointcut Pointcuts}：。
 * 
 * @author Rob Harrop
...
public class AopNamespaceHandler extends NamespaceHandlerSupport {
	 ...
	 * 
	 * <pre class="code">
	 * &lt; aop：advisor id ="getAgeAdvisor" pointcut ="执行(* * ITestBeangetAge())"建议-REF =&QUOT; getAgeCounte
	 * r&QUOT; /&GT;。
	 * 
	 *  &lt; aop：advisor id ="getNameAdvisor"切入点-REF =&QUOT; getNameCalls&QUOT;建议-REF =&QUOT; getNameCounter
	 */
	@Override
	public void init() {
