 ...
 *
 * <p>
 * 实现持有给定对象的{@link orgspringframeworkaopTargetSource}接口这是Spring AOP框架使用的TargetSource接口的默认实现通常不需要在应用程序代码中
 * 创建此类的对象。
 * 
 *  <p>这个类是可序列化的但是,SingletonTargetSource的实际可序列化将取决于目标是否可序列化
 * 
 * 
 * @author Rod Johnson
...
public class SingletonTargetSource implements TargetSource, Serializable {
	 ...
	 * <p>
	 *  为给定的目标创建一个新的SingletonTargetSource
	 * 
	 * 
