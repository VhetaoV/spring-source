 ...
 *
 * <p>
 *  坚持{@code javautilProperties}的策略界面,允许可插拔解析策略
 * 
 * <p>默认实现是DefaultPropertiesPersister,提供{@code javautilProperties}的本机解析,但允许从任何读取器读取并写入任何Writer(允许为属性文件指定
 * 编码)。
 * 
 * 
...
public interface PropertiesPersister {
	 ...
	 * Properties object.
	 * <p>
	 *  将属性从给定的Reader加载到给定的Properties对象中
	 * 
	 * 
	 * @param props the Properties object to load into
	 ...
	 * given OutputStream.
	 * <p>
	 *  将给定的Properties对象的内容写入给定的OutputStream
	 * 
	 * 
	 ...
	 * given Writer.
	 * <p>
	 *  将给定的Properties对象的内容写入给定的Writer
	 * 
	 * 
	 * @param props the Properties object to store
	 ...
	 * <p>
	 *  将给定的Properties对象的内容写入给定的XML OutputStream
	 * 
	 * 
	 * @param props the Properties object to store
	 * @param os the OutputStream to write to
