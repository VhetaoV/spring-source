 ...
 *
 * <p>
 *  Helper课程为{@link ListenableFuture}实现,维护成功和失败的回调,并有助于通知他们
 * 
 *  <p>灵感来自{@code comgooglecommonutilconcurrentExecutionList}
 * 
 * 
...
public class ListenableFutureCallbackRegistry<T> {
	 ...
	 * <p>
	 *  在给定结果的所有添加回调上触发{@link ListenableFutureCallback#onSuccess(Object)}调用
	 * 
	 * 
	 ...
	 * <p>
	 *  触发{@link ListenableFutureCallback#onFailure(Throwable)}调用所有添加的回调与给定的{@code Throwable}
	 * 
