 ...
 *
 * <p>
 * 将通过S参数化的{@link Future}的{@link Future}适配为通过T All方法参数化的{@code Future}的抽象类被委派给适配器,其中{@link #get()}和{@link #get(long,TimeUnit )}
 * 调用{@link #adapt(Object)}关于适配器的结果。
 * 
 * 
...
public abstract class FutureAdapter<T, S> implements Future<T> {
	 ...
	 * <p>
	 *  与给定的适配器构建新的{@code FutureAdapter}
	 * 
	 * 
