 ...
 * 
 * <p>文本可能包含{@code $ {}}占位符,要解析为系统属性：例如{@code $ {userdir}}默认值可以使用键和值之间的"："分隔符
 * 
 * 
...
public abstract class SystemPropertyUtils {
	 ...
	 * <p>
	 *  解决给定文本中的{@code $ {}}占位符,将其替换为相应的系统属性值
	 * 
	 * 
	 ...
	 * <p>
	 *  解决给定文本中的{@code $ {}}占位符,用相应的系统属性值替换它们。如果标志设置为{@code true},则将忽略不带默认值的Unresolvable占位符并将其传递不变;
	 * 
	 * 
	 * @param text the String to resolve
	 ...
	 * <p>
	 *  解决系统属性和系统环境变量的PlaceholderResolver实现
	 */
