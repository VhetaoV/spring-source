 ...
 *
 * <p>
 *  包含与{@link javaxxmltransformTransformer Transformers}和{@code javaxxmltransform}包相关的常见行为
 * 
 * 
 * @author Rick Evans
...
public abstract class TransformerUtils {
	 ...
	 * <p>Defaults to "2".
	 * <p>
	 * 如果启用了{@link #enableIndenting(javaxxmltransformTransformer)缩进),则缩进字符数} <p>默认为"2"
	 * 
	 */
	 ...
	 *
	 * <p>
	 *  为所提供的{@link javaxxmltransformTransformer}启用缩进<p>如果底层XSLT引擎是Xalan,则特殊输出密钥{@code indent-amount}也将设置为{@link #DEFAULT_INDENT_AMOUNT}
	 * 个字符的值。
	 * 
	 * 
