 ...
 *
 * <p>
 *  简单的{@code javaxxmlnamespaceNamespaceContext}实现遵循标准的{@code NamespaceContext}合约,可以通过{@code javautilMap}
 * 或{@code javautilProperties}对象加载。
 * 
 * 
