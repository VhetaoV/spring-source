 ...
 *
 * <p>
 *  写入{@link javaxxmlstreamutilXMLEventConsumer}的SAX {@link orgxmlsaxContentHandler}和{@link LexicalHandler}
 * 。
 * 
 * 
...
class StaxEventHandler extends AbstractStaxHandler {
	 ...
	 * <p>
	 * 构造一个写入给定的{@code XMLEventWriter}的{@code StaxEventContentHandler}的新实例默认{@code XMLEventFactory}将被创建
	 * 
	 * 
	 ...
	 * <p>
	 *  构造一个新的{@code StaxEventContentHandler}实例,它使用给定的事件工厂来创建事件并写入给定的{@code XMLEventConsumer}
	 * 
	 * @param eventWriter the writer to write events to
