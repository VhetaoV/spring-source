 ...
 *  杂项计算方法
 * 
 *  <p>主要用于框架内部使用;考虑<a href=\"http://commonsapacheorg/codec/\"> Apache Commons Codec </a>,以获得更全面的摘要实用程序套
 * 件。
 * 
 * 
...
public abstract class DigestUtils {
	 ...
	 * <p>
	 *  将给定字节的MD5摘要的十六进制字符串表示法附加到给定的{@link StringBuilder}
	 * 
	 * 
	 * @param bytes the bytes to calculate the digest over
	 ...
	 * <p>
	 *  使用给定的算法创建一个新的{@link MessageDigest},因为{@code MessageDigest}不是线程安全的
	 */
