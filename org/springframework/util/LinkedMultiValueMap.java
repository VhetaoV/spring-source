 ...
 *
 * <p>
 *  {@link MultiValueMap}的简单实现,包含{@link LinkedHashMap},将多个值存储在{@link LinkedList}
 * 
 * <p>此Map实现通常不是线程安全的它主要用于从请求对象暴露的数据结构,仅在单个线程中使用
 * 
 * 
...
public class LinkedMultiValueMap<K, V> implements MultiValueMap<K, V>, Serializable {
	 ...
	 * <p>
	 *  创建一个新的LinkedMultiValueMap,其中包含{@link LinkedHashMap}
	 * 
	 */
	 ...
	 * <p>
	 *  创建一个新的LinkedMultiValueMap,该绑定包含给定初始容量的{@link LinkedHashMap}
	 * 
	 * 
	 ...
	 * <p>
	 *  复制构造函数：创建一个与指定的Map相同映射的新的LinkedMultiValueMap注意这将是一个浅拷贝;其持有的列表条目将被重用,因此无法独立修改
	 * 
	 * 
