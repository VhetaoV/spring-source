 ...
 *
 * <p>
 *  接口由{@code MetadataMBeanInfoAssembler}用于从受管资源的类中读取源级元数据
 * 
 * 
 * @author Rob Harrop
...
public interface JmxAttributeSource {
	 ...
	 * <p>
	 * 如果提供的{@code Class}具有适当的元数据,则实现应返回{@code ManagedResource}的实例。否则返回{@code null}
	 * 
	 * 
	 ...
	 * Otherwise should return {@code null}.
	 * <p>
	 *  如果提供的{@code方法}具有相应的元数据,则实现应返回{@code ManagedAttribute}的实例,否则返回{@code null}
	 * 
	 * 
	 ...
	 * Otherwise should return {@code null}.
	 * <p>
	 *  如果提供的{@code方法}具有相应的元数据,则实现应返回{@code ManagedMetric}的实例,否则返回{@code null}
	 * 
	 * 
	 * @param method the method to read the attribute data from
	 ...
	 * Otherwise should return {@code null}.
	 * <p>
	 *  如果提供的{@code方法}具有相应的元数据,则实现应返回{@code ManagedOperation}的实例,否则返回{@code null}
	 * 
	 * 
	 * @param method the method to read the attribute data from
	 * @return the attribute, or {@code null} if not found
	 ...
	 * <p>
	 * 如果提供的{@code方法}具有相应的元数据,则实现应返回{@code ManagedOperationParameter}的数组。否则,如果没有找到元数据,则应返回一个空数组
	 * 
	 * 
	 ...
	 * <p>
	 *  如果提供的{@code Class}具有相应的元数据,实现应该返回一个{@link ManagedNotification ManagedNotifications}数组,否则应该返回一个空数组
	 * 
