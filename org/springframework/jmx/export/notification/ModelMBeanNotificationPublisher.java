 ...
 *
 * <p>
 * {@link NotificationPublisher}实现,它使用{@link ModelMBean}界面提供的基础架构来跟踪{@link javaxmanagementNotificationListener javaxmanagementNotificationListeners}
...
public class ModelMBeanNotificationPublisher implements NotificationPublisher {
	 ...
	 * <p>
	 *  {@link ModelMBean}实例包装将被注入此{@code NotificationPublisher}的托管资源
	 * 
	 */
	 ...
	 * <p>
	 *  创建一个{@link ModelMBeanNotificationPublisher}类的新实例,该实例将发布所有{@link javaxmanagementNotification通知}到提供的{@link ModelMBean}
	 * 。
	 * 
	 * 
	 ...
	 * <p>
	 * 使用包装的{@link ModelMBean}实例发送提供的{@link通知}
	 * 
	 * 
	 ...
	 * <p>
	 *  从{@link Notification javadoc}：<p> <i>"强烈建议通知发件人使用对象名称而不是对MBean对象的引用作为源"</i>
	 * 
