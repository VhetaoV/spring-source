 ...
 *
 * <p>
 * 汇总一个{@link javaxmanagementNotificationListener},一个{@link javaxmanagementNotificationFilter}和一个任意的回交对象
 * 的助手类,以及侦听器希望接收的MBean的名称{@link javaxmanagementNotification Notifications}。
 * 
 * 
...
public class NotificationListenerHolder {
	 ...
	 * <p>
	 *  设置{@link javaxmanagementNotificationListener}
	 * 
	 */
	 ...
	 * <p>
	 *  获取{@link javaxmanagementNotificationListener}
	 * 
	 */
	 ...
	 * <p>May be {@code null}.
	 * <p>
	 *  设置与封装的{@link #getNotificationFilter()NotificationFilter)关联的{@link javaxmanagementNotificationFilter}
	 *  <p>可能是{@code null}。
	 * 
	 */
	 ...
	 * <p>May be {@code null}.
	 * <p>
	 *  返回与封装的{@link #getNotificationFilter()NotificationFilter)关联的{@link javaxmanagementNotificationFilter}
	 *  <p>可能是{@code null}。
	 * 
	 */
	 ...
	 * <p>
	 * 设置(任意)对象,当通知任何{@link javaxmanagementNotificationListener}时,将由{@link javaxmanagementNotificationBroadcaster}
	 * 按照"回传"。
	 * 
	 * 
	 ...
	 * any {@link javax.management.NotificationListener}.
	 * <p>
	 *  返回(任意)对象,当通知任何{@link javaxmanagementNotificationListener}时,将由{@link javaxmanagementNotificationBroadcaster}
	 * 按原样返回;。
	 * 
	 * 
	 ...
	 * <p>
	 *  设置封装的{@link #getNotificationFilter()NotificationFilter}将注册的单个MBean的{@link javaxmanagementObjectName}
	 * 样式名称,以侦听{@link javaxmanagementNotification Notifications}可以指定为{@code ObjectName}实例或作为{@code String}。
	 * 
	 * 
	 ...
	 * <p>
	 * 设置封装的{@link #getNotificationFilter()NotificationFilter}注册的MBean的{@link javaxmanagementObjectName}样式名称
	 * 数组,以侦听{@link javaxmanagementNotification Notifications}可以指定为{@code ObjectName}实例或者{@code String}。
	 * 
	 * 
	 ...
	 * <p>
	 *  返回{@link javaxmanagementObjectName}的列表,封装的{@link #getNotificationFilter()NotificationFilter}将被注册为{@link javaxmanagementNotification Notifications}
	 * 的侦听器的String表示形式。
	 * 
