 ...
 *
 * <p>
 *  Helper类用于创建{@link javaxmanagementObjectName}实例
 * 
 * 
 * @author Rob Harrop
...
public class ObjectNameManager {
	 ...
	 * <p>
	 *  检索与提供的名称相对应的{@code ObjectName}实例
	 * 
	 * 
	 ...
	 * <p>
	 *  使用提供的键和值检索指定域的一个{@code ObjectName}实例和一个属性
	 * 
	 * 
	 ...
	 * <p>
	 *  检索具有指定域名和提供的键/名称属性的{@code ObjectName}实例
	 * 
	 * @param domainName the domain name for the {@code ObjectName}
