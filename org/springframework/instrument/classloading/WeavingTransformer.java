 ...
 *
 * <p>
 *  基于ClassFileTransformer的编织器,允许将变量应用于类字节数组的列表通常用于类加载器
 * 
 * 注意：此类是为了最小化外部依赖关系而故意实现的,因为它包含在weaver jar中(要部署到应用程序服务器中)
 * 
 * 
 * @author Rod Johnson
 * @author Costin Leau
...
public class WeavingTransformer {
	 ...
	 * <p>
	 *  在给定的类字节定义上应用转换该方法将始终返回一个非空字节数组(如果没有发生变换,数组内容将与原始字节数组相同)
	 * 
	 * 
