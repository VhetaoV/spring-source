 ...
 *
 * <p>
 *  用于在目标对象上执行{@link RemoteInvocation}的策略界面
 * 
 * <p>由{@link orgspringframeworkremotingrmiRmiServiceExporter}(用于RMI调用者)和{@link orgspringframeworkremotinghttpinvokerHttpInvokerServiceExporter}
 * 使用。
 * 
