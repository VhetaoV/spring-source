...
public class HessianExporter extends RemoteExporter implements InitializingBean {
	 ...
	 * <p>
	 *  指定Hessian SerializerFactory以使用<p>这将通常作为类型为{@code comcauchohessianioSerializerFactory}的内部bean定义传递,应用自
	 * 定义bean属性值。
	 * 
	 */
	 ...
	 * <p>
	 * 设置是否启用Hessian的调试模式,登录到此出口商的Commons Logging日志默认值为"false"
	 * 
	 * 
