 ...
 *
 * <p>
 *  在Spring管理的bean中检查JSR-303约束注释的简单{@link BeanPostProcessor},在调用bean的init方法(如果有的话)之前抛出一个初始化异常,
 * 
 * 
...
public class BeanValidationPostProcessor implements BeanPostProcessor, InitializingBean {
	 ...
	 * <p>
	 * 将JSR-303验证器设置为委托以验证bean <p>默认值为默认ValidatorFactory的默认验证器
	 * 
	 */
	 ...
	 * <p>Default is the default ValidatorFactory's default Validator.
	 * <p>
	 *  将JSR-303 ValidatorFactory设置为委托以验证bean,使用其默认验证器<p>默认值为默认ValidatorFactory的默认验证器
	 * 
	 * 
	 ...
	 * <p>
	 *  选择是否在bean初始化后执行验证(即在init方法之后),而不是之前(默认情况下)<p>默认值为"false"(初始化之前)如果您希望将其切换为"true"(初始化后)给init方法一个机会来填充约
	 * 束字段才能被验证。
	 * 
	 */
