 ...
 *
 * <p>
 *  {@link错误}界面的抽象实现提供对评估错误的通用访问;然而,并没有定义具体的管理{@link ObjectError ObjectErrors}和{@link FieldError FieldErrors}
 * 。
 * 
 * 
...
public abstract class AbstractErrors implements Errors, Serializable {
	 ...
	 * <p>
	 * 实际设置由setNestedPath和pushNestedPath委派的嵌套路径
	 * 
	 */
	 ...
	 * <p>
	 *  确定给定字段的规范字段名称<p>默认实现仅按原样返回字段名称
	 * 
	 * 
