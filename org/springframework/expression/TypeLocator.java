...
public interface TypeLocator {
	 ...
	 * <p>
	 *  这个接口的实现者预计能够定位类型他们可以使用自定义{@link ClassLoader}和/或处理常见的包前缀(例如{@code javalang}),但是他们希望
	 * 
	 * <p>有关示例实现,请参阅{@link orgspringframeworkexpressionspelsupportStandardTypeLocator}
	 * 
	 * 
