 ...
 *
 * <p>
 *  默认情况下,数学运算符{@link Operation}支持类似数字的简单类型通过提供OperatorOverloader的实现,表达式语言的用户可以支持其他类型的操作
 * 
 * 
 * @author Andy Clement
 * @since 3.0
...
public interface OperatorOverloader {
	 ...
	 * <p>
	 * 如果操作符重载器支持两个操作数之间的指定操作,则返回true,因此应该调用它来处理它
	 * 
	 * 
	 ...
	 * <p>
	 *  对两个操作数执行指定的操作,返回结果有关支持的操作,请参阅{@link操作}
	 * 
	 * @param operation the operation to be performed
	 * @param leftOperand the left operand
	 * @param rightOperand the right operand
