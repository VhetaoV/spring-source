 ...
 *
 * <p>
 * {@link资源}描述符的{@link javabeansPropertyEditor Editor},可以将{@code String}位置(例如{@code file：C：/ myfiletxt}或
 * {@code classpath：myfiletxt})自动转换为{@code Resource}属性使用{@code String}位置资源。
 * 
 *  <p>路径可能包含{@code $ {}}占位符,要解析为{@link orgspringframeworkcoreenvEnvironment}属性：例如{@code $ {userdir}}默认情
 * 况下忽略不可解决的占位符。
 * 
 *  <p>委派给{@link ResourceLoader}以进行大力提升,默认情况下使用{@link DefaultResourceLoader}
 * 
 * 
...
public class ResourceEditor extends PropertyEditorSupport {
	 ...
	 * <p>
	 *  解决给定的路径,如有必要,从{@code环境}中替换具有相应属性值的占位符
	 * 
