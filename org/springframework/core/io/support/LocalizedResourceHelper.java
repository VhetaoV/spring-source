 ...
 *
 * <p>
 *  用于加载通过名称,扩展名和当前语言环境指定的本地化资源的助手类
 * 
 * 
...
public class LocalizedResourceHelper {
	 ...
	 * <p>
	 *  找到给定名称,扩展名和区域设置的最具体的本地化资源：<p>该文件将按照以下顺序搜索位置,类似于{@code javautilResourceBundle}的搜索顺序：
	 * <ul>
	 *  <li> [name] _ [language] _ [country] _ [variant] [extension] <li> [name] _ [language] _ [country] [e
	 * xtension] <li> [name] _ [language] ] <li> [name] [extension]。
	 * 
