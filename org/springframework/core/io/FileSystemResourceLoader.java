 ...
 *
 * <p>
 *  {@link ResourceLoader}实现,将简单路径解析为文件系统资源,而不是类路径资源(后者是{@link DefaultResourceLoader}的默认策略)
 * 
 * <p> <b>注意：</b>平滑路径将始终被解释为相对于当前VM工作目录,即使它们以斜杠开头(这与Servlet容器中的语义一致)<b>使用一个明确的"file："前缀来强制绝对文件路径</b>
 * 
 *  <p> {@ link orgspringframeworkcontextsupportFileSystemXmlApplicationContext}是一个全面的ApplicationContext
 * 实现,提供相同的资源路径解决策略。
 * 
 * 
...
public class FileSystemResourceLoader extends DefaultResourceLoader {
	 ...
	 * <p>
	 *  解决资源路径作为文件系统路径<p>注意：即使给定的路径以斜杠开头,它将被解释为相对于当前的VM工作目录
	 * 
	 */
