 ...
 *
 * <p>
 *  用于查找Spring正在运行的Java / JVM版本的内部助手类,以便自动适应当前平台的功能
 * 
 * <p>请注意,自Spring 40起,Spring需要JVM 16或更高版本
 * 
 * 
 * @author Rod Johnson
...
public abstract class JdkVersion {
	 ...
	 * <p>
	 *  返回完整的Java版本字符串,由{@code SystemgetProperty("javaversion")返回}
	 * 
	 * 
	 ...
	 * <p>
	 *  获取主要版本代码这意味着我们可以像{@code if(getMajorJavaVersion()> = JAVA_17)}
	 * 
