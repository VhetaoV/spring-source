...
public class ConcurrentExecutorAdapter implements Executor {
	 ...
	 * <p>
	 *  适配器暴露了任何Spring {@link orgspringframeworkcoretaskTaskExecutor}的{@link javautilconcurrentExecutor}接口
	 * 
	 * 由于TaskExecutor本身扩展了Executor接口,所以这种方法不那么有用。该适配器仅与<em>隐藏给定对象的TaskExecutor性质相关,仅将标准Executor接口暴露于客户
	 * 
	 * 
