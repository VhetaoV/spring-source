 ...
 *
 * <p>
 *  {@link InvocationHandler}针对Spring已经使用</em>(即包含在动态代理中)的{@link Annotation}具有附加功能
 * 
 * 
 * @author Sam Brannen
 * @since 4.2
...
class SynthesizedAnnotationInvocationHandler implements InvocationHandler {
	 ...
	 * <p>
	 * 为提供的{@link AnnotationAttributeExtractor}构造一个新的{@code SynthesizedAnnotationInvocationHandler}
	 * 
	 * 
	 ...
	 * <p>
	 *  警告：我们不能在Spring的{@link ObjectUtils}中使用任何{@code nullSafeHashCode()}方法,因为这些哈希码生成算法不符合{@link Annotation#hashCode())中指定的要求。
	 * 
	 * 
