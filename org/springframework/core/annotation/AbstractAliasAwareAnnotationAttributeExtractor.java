 ...
 *
 * <p>
 *  {@link AnnotationAttributeExtractor}实现的抽象基类,透明地强制使用{@link AliasFor @AliasFor}注释的注释属性的属性别名语义
 * 
 * 
 * @author Sam Brannen
 * @since 4.2
...
abstract class AbstractAliasAwareAnnotationAttributeExtractor<S> implements AnnotationAttributeExtractor<S> {
	 ...
	 * <p>
	 * 构造一个新的{@code AbstractAliasAwareAnnotationAttributeExtractor}
	 * 
	 * 
	 ...
	 * attribute method.
	 * <p>
	 *  从与提供的属性方法对应的底层{@linkplain #getSource源}获取原始的,未修改的属性值
	 * 
	 */
	 ...
	 * attribute name.
	 * <p>
	 *  从与提供的属性名称相对应的底层{@linkplain #getSource源}获取原始,未修改的属性值
	 */
