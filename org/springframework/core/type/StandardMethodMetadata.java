 ...
 *
 * <p>
 *  {@link MethodMetadata}实现,使用标准反射来内省给定的{@code方法}
 * 
 * 
...
public class StandardMethodMetadata implements MethodMetadata {
	 ...
	 * <p>
	 *  为给定的方法创建一个新的StandardMethodMetadata包装器
	 * 
	 * 
	 ...
	 * <p>
	 * 为给定的方法创建一个新的StandardMethodMetadata包装器,提供以{@link orgspringframeworkcoreannotationAnnotationAttributes}
	 * 的形式返回任何嵌套注释或注释数组的选项,而不是实际的{@link javalangannotationAnnotation}实例。
	 * 
	 * 
	 * @param introspectedMethod the Method to introspect
