 ...
 *
 * <p>
 *  {@link AnnotationMetadata}实现,使用标准反射内省给定的{@link类}
 * 
 * 
...
public class StandardAnnotationMetadata extends StandardClassMetadata implements AnnotationMetadata {
	 ...
	 * <p>
	 * 为给定的类创建一个新的{@link StandardAnnotationMetadata}包装器,提供以{@link orgspringframeworkcoreannotationAnnotationAttributes}
	 * 形式返回任何嵌套注释或注释数组的选项,而不是实际的{@link注释}实例。
	 * 
	 * @param introspectedClass the Class to introspect
