 ...
 *
 * <p>
 *  {@link PropertyResolver}实现,根据{@link PropertySources}的底层解析属性值
 * 
 * 
 * @author Chris Beams
...
public class PropertySourcesPropertyResolver extends AbstractPropertyResolver {
	 ...
	 * <p>
	 * 记录在给定的{@link PropertySource}中找到的给定键,导致给定的值<p>默认实现写入具有键和源的调试日志消息至于433,这不会记录值,以避免敏感设置的意外记录子类可以覆盖此方法以更改日
	 * 志级别和/或日志消息,包括属性值(如果需要)。
	 * 
