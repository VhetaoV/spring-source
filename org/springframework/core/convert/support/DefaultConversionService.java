 ...
 *
 * <p>
 *  默认情况下配置的适用于大多数环境的转换器的{@link GenericConversionService}的专业化
 * 
 * <p>设计用于直接实例化,但还暴露了静态{@link #addDefaultConverters(ConverterRegistry)}实用方法,用于对任何{@code ConverterRegistry}
 * 实例进行临时使用。
 * 
 * 
 * @author Chris Beams
...
public class DefaultConversionService extends GenericConversionService {
	 ...
	 * <p>
	 *  使用{@linkplain DefaultConversionService#addDefaultConverters(ConverterRegistry)默认转换器)创建一个新的{@code DefaultConversionService}
	 * 。
	 * 
	 */
	 ...
	 * <p>
	 *  内部类避免了对Java 8的{@code javatime}包的硬编码依赖
	 */
