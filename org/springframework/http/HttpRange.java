 ...
 *
 * <p>
 *  表示与HTTP {@code"Range"}标题一起使用的HTTP(字节)范围
 * 
 * 
...
public abstract class HttpRange {
	 ...
	 * <p>
	 *  使用当前{@code HttpRange}中包含的范围信息将{@code资源}转换为{@link ResourceRegion}
	 * 
	 * 
	 ...
	 * <p>
	 *  从给定的拳头创建一个{@code HttpRange}到最后一个位置
	 * 
	 * 
	 * @param firstBytePos the first byte position
	 ...
	 * <p>
	 *  将给定的逗号分隔的字符串解析成{@code HttpRange}对象的列表<p>此方法可用于解析{@code Range}标题
	 * 
	 * 
	 ...
	 * <p>
	 *  将每个{@code HttpRange}转换成{@code ResourceRegion},使用HTTP范围信息选择给定的{@code资源}的相应段
	 * 
	 * 
	 ...
	 * <p>
	 * 返回{@code HttpRange}对象的给定列表的字符串表示<p>此方法可用于{@code Range}标题
	 * 
	 * 
