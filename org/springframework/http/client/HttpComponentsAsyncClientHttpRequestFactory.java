 ...
 *
 * <p>
 *  {@link HttpComponentsClientHttpRequestFactory}的异步扩展使用<a href=\"http://hcapacheorg/httpcomponents-asyncclient-dev/\">
 *  Apache HttpComponents HttpAsyncClient 40 </a>创建请求。
 * 
 * 
...
public class HttpComponentsAsyncClientHttpRequestFactory extends HttpComponentsClientHttpRequestFactory
	 ...
	 * <p>
	 * 使用默认{@link HttpAsyncClient}和{@link HttpClient}创建{@code HttpComponentsAsyncClientHttpRequestFactory}的新
	 * 实例。
	 * 
	 */
	 ...
	 * <p>
	 *  使用给定的{@link HttpAsyncClient}实例创建{@code HttpComponentsAsyncClientHttpRequestFactory}的新实例,并使用默认的{@link HttpClient}
	 * 。
	 * 
	 * 
	 ...
	 * <p>
	 *  使用给定的{@link HttpClient}和{@link HttpAsyncClient}实例创建{@code HttpComponentsAsyncClientHttpRequestFactory}
	 * 的新实例。
	 * 
	 * 
	 ...
	 * <p>
	 *  设置用于{@linkplain #createAsyncRequest(URI,HttpMethod)异步执行)的{@code HttpClient}
	 * 
	 */
	 ...
	 * {@linkplain #createAsyncRequest(URI, HttpMethod) asynchronous execution}.
	 * <p>
	 *  返回用于{@linkplain #createAsyncRequest(URI,HttpMethod)异步执行)的{@code HttpClient}
	 */
