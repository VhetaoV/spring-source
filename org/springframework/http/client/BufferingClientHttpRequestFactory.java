 ...
 * 
 *  <p>使用这个包装器允许多次读取@linkplain ClientHttpResponse#getBody()响应体}
 * 
 * 
...
public class BufferingClientHttpRequestFactory extends AbstractClientHttpRequestFactoryWrapper {
	 ...
	 * <p>
	 * 为给定的{@link ClientHttpRequestFactory}创建缓冲包装器
	 * 
	 * 
	 ...
	 * <p>
	 *  指示给定的URI和方法的请求/响应交换是否应该缓存在内存中<p>默认实现为所有URI和方法返回{@code true}子类可以覆盖此方法来更改此行为
	 * 
	 * @param uri the URI
