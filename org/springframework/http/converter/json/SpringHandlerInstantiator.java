 ...
 *
 * <p>
 *  允许在Spring {@link ApplicationContext}中创建自动布线的杰克逊({@link JsonSerializer},{@link JsonDeserializer},{@link KeyDeserializer}
 * ,{@link TypeResolverBuilder},{@link TypeIdResolver}))。
 * 
 * <p>从Spring 43开始,这将覆盖{@link HandlerInstantiator}中的所有工厂方法,包括非抽象方法,最近从Jackson 24和25引入的方法：{@link ValueInstantiator}
 * ,{@link ObjectIdGenerator},{@链接ObjectIdResolver},{@link PropertyNamingStrategy},{@link转换器},{@link VirtualBeanPropertyWriter}
 * 
