 ...
 *
 * <p>
 *  实施{@link HttpMessageConverter},可以读取和写入{@link资源资源}并支持字节范围请求
 * 
 * <p>默认情况下,此转换器可以读取所有媒体类型Java Activation Framework(JAF) - 如果可用 - 用于确定书面资源的{@code Content-Type}如果JAF不可用,
 * {@code application /八位字节流}。
 * 
