 ...
 *
 * <p>
 *  使用JAXB2的{@link orgspringframeworkhttpconverterHttpMessageConverter HttpMessageConverters}的抽象基类懒惰地生成{@link JAXBContext}
 * 对象。
 * 
 * 
...
public abstract class AbstractJaxb2HttpMessageConverter<T> extends AbstractXmlHttpMessageConverter<T> {
	 ...
	 * <p>
	 * 自定义此消息转换器创建的{@link Marshaller},然后再使用该消息将对象写入输出
	 * 
	 * 
	 ...
	 * <p>
	 *  自定义此消息转换器创建的{@link Unmarshaller},然后再使用它从输入读取对象
	 * 
	 * 
