 ...
 *
 * <p>
 *  安装将Joda-Time支持集成到Spring的现场格式化系统中所需的低级类型转换器
 * 
 * <p>注意：{@link JodaTimeFormatterRegistrar}安装这些转换器,并依赖其中的几个转换器为其自定义转换场景注册一些额外的转换器
 * 
 * 
 * @author Keith Donald
 * @author Phillip Webb
...
final class JodaTimeConverters {
	 ...
	 * <p>
	 *  在使用ReadableInstantPrinter打印{@code javautilDate}字段时使用
	 * 
	 * 
	 ...
	 * <p>
	 *  在使用ReadableInstantPrinter打印{@code javautilCalendar}字段时使用
	 * 
	 * 
	 * @see MillisecondInstantPrinter
	 * @see JodaDateTimeFormatAnnotationFormatterFactory
	 ...
	 * <p>
	 *  在使用ReadableInstantPrinter打印长字段时使用
	 * 
	 * @see MillisecondInstantPrinter
	 * @see JodaDateTimeFormatAnnotationFormatterFactory
	 */
