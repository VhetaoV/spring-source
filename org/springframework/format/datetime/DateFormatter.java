 ...
 *
 * <p>
 *  用于{@link javautilDate}类型的格式化程序允许配置显式日期模式和区域设置
 * 
 * 
 * @author Keith Donald
...
public class DateFormatter implements Formatter<Date> {
	 ...
	 * <p>
	 * 设置用于格式化日期值的模式<p>如果未指定,将使用DateFormat的默认样式
	 * 
	 */
	 ...
	 * <p>If not specified, DateFormat's default style will be used.
	 * <p>
	 *  设置用于格式化日期值的样式<p>如果未指定,将使用DateFormat的默认样式
	 * 
	 * 
	 ...
	 * <p>
	 *  设置用于格式化日期值的两个字符用于日期样式的第一个字符,第二个字符用于支持的字符
	 * <ul>
