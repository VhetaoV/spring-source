 ...
 *
 * <p>
 *  安装将JSR-310支持集成到Spring的现场格式化系统中所需的较低级别的转换器
 * 
 * 注意：{@link DateTimeFormatterRegistrar}安装这些转换器,但不依赖于它们的格式化器它们正在为不同JSR-310值类型之间以及{@link javautilCalendar}
 * 和JSR-310之间的自定义转换方案注册值类型。
 * 
