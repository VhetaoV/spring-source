 ...
 *
 * <p>
 *  用于评估和缓存在{@link javalangreflectAnnotatedElement}上定义的Spel表达式的共享实用程序类
 * 
 * 
...
public abstract class CachedExpressionEvaluator {
	 ...
	 * <p>
	 *  使用指定的{@link SpelExpressionParser}创建一个新的实例
	 * 
	 */
	 ...
	 * <p>
	 * 使用默认的{@link SpelExpressionParser}创建一个新的实例
	 * 
	 */
	 ...
	 * <p>
	 *  返回指定SpEL值的{@link Expression} <p>解析表达式(如果还没有)
	 * 
