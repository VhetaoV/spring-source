 ...
 *
 * <p>
 *  Helper类,允许以{@link javautilResourceBundle}方式访问Spring {@link orgspringframeworkcontextMessageSource},例
 * 如将Spring MessageSource暴露给JSTL Web视图。
 * 
 * 
...
public class MessageSourceResourceBundle extends ResourceBundle {
	 ...
	 * <p>
	 *  如果消息无法解析,此实现将解析MessageSource Returns {@code null}中的代码
	 * 
	 */
	@Override
	 ...
	 * <p>
	 *  此实现检查目标MessageSource是否可以解析给定密钥的消息,相应地翻译{@code NoSuchMessageException}与JDK 16中的ResourceBundle的默认实现相反,
	 * 这不依赖于枚举消息密钥的功能。
	 * 
	 */
	@Override
	 ...
	 * <p>
	 *  此实现会引发{@code UnsupportedOperationException},因为MessageSource不允许枚举定义的消息代码
	 * 
	 */
	@Override
	 ...
	 * <p>
	 * 此实现通过标准{@code ResourceBundlegetLocale()}方法公开指定的Locale进行自省
	 */
	@Override
