 ...
 *
 * <p>
 *  默认{@link LoadTimeWeaver} bean用于应用程序上下文,装饰自动检测到的内部{@code LoadTimeWeaver}
 * 
 * 通常为默认bean名称"{@code loadTimeWeaver}"注册; Spring的{@code <context：load-time-weaver>} XML标签最方便的方法是实现这一点
 * 
 *  <p>此类实现了运行时环境检查,以获取适当的weaver实现：从Spring 40起,它将检测Oracle WebLogic 10,GlassFish 3,Tomcat 6,7和8,JBoss AS 
 * 5,6和7,IBM WebSphere 7和8,{@link InstrumentationSavingAgent Spring的VM代理}和Spring的{@link ReflectiveLoadTimeWeaver}
 * 
