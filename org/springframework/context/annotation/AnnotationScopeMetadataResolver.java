 ...
 *
 * <p>
 *  一个{@link ScopeMetadataResolver}实现,默认情况下检查Spring的{@link Scope @Scope}注释在bean类上的存在
 * 
 * <p>通过{@link #setScopeAnnotationType(Class)}可以配置检查的注释类型。
 * 
 * 
 * @author Mark Fisher
...
public class AnnotationScopeMetadataResolver implements ScopeMetadataResolver {
	 ...
	 * <p>
	 *  使用提供的默认{@link ScopedProxyMode}构造新的{@code AnnotationScopeMetadataResolver}
	 * 
	 * 
	 ...
	 * <p>
	 *  设置此{@code AnnotationScopeMetadataResolver}检查的注释类型
	 * 
