...
class ConditionEvaluator {
	 ...
	 * <p>
	 * 根据{@code @Conditional}注释确定是否应该跳过一个项目{@link ConfigurationPhase}将从项目类型中推导出来(即{@code @Configuration}类将是{@link ConfigurationPhase#PARSE_CONFIGURATION}
	 * )。
	 * 
	 * 
	 ...
	 * Determine if an item should be skipped based on {@code @Conditional} annotations.
	 * <p>
	 *  根据{@code @Conditional}注释确定是否应跳过一个项目
	 * 
	 * 
	 * @param metadata the meta data
