 ...
 *
 * <p>
 *  读取给定的完全填充的一组ConfigurationClass实例,使用给定的{@link BeanDefinitionRegistry}根据其内容注册bean定义
 * 
 * <p>此类是在{@link BeanDefinitionReader}层次结构之后建模的,但不会实现/扩展其任何工件,因为一组配置类不是{@link Resource}
 * 
 * 
 * @author Chris Beams
...
class ConfigurationClassBeanDefinitionReader {
	 ...
	 * <p>
	 *  创建一个新的{@link ConfigurationClassBeanDefinitionReader}实例,将用于填充给定的{@link BeanDefinitionRegistry}
	 * 
	 */
	 ...
	 * <p>
	 *  阅读{@code configurationModel},根据注册表的内容注册bean定义
	 * 
	 */
	 ...
	 * <p>
	 * {@link RootBeanDefinition}标记子类,用于表示从定义类中创建的bean定义,而不是任何其他配置源在bean重写的情况下,需要确定bean定义是否在外部创建
	 * 
	 */
	 ...
	 * account 'imported by'.
	 * <p>
	 *  评估{@code @Conditional}注释,跟踪结果并考虑"由...导入"
	 */
