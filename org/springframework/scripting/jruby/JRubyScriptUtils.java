...
public abstract class JRubyScriptUtils {
	 ...
	 * <p>
	 *  从给定的脚本源创建一个新的JRuby脚本对象,使用默认的{@link ClassLoader}
	 * 
	 * 
	 ...
	 * <p>
	 *  初始化{@link orgjrubyRuby}运行时的一个实例
	 * 
	 */
	 ...
	 * <p>
	 *  给定JRuby AST中的根{@link Node}将定位由该AST定义的类的名称
	 * 
	 * 
	 ...
	 * <p>
	 *  从JRuby方法调用抛出的JRuby {@link RaiseException}引发异常
	 * 
	 */
	...
	public static class JRubyExecutionException extends NestedRuntimeException {
		 ...
		 * <p>
		 * 创建一个新的{@code JRubyException},包装给定的JRuby {@code RaiseException}
		 * 
