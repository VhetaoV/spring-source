 ...
 *
 * <p>
 * 基于Spring的{@link orgspringframeworkcoreioResource}抽象的{@link orgspringframeworkscriptingScriptSource}实现
 * 从底层Resource的{@link orgspringframeworkcoreioResource#getFile()File}或{@link orgspringframeworkcoreioResource#getInputStream()InputStream}
 * 中载入脚本文本,文件的修改时间戳(如果可能的话)。
 * 
 * 
 * @author Rob Harrop
...
public class ResourceScriptSource implements ScriptSource {
	 ...
	 * <p>
	 *  为给定的资源创建一个新的ResourceScriptSource
	 * 
	 * 
	 ...
	 * script from.
	 * <p>
	 *  返回{@link orgspringframeworkcoreioResource}以加载脚本
	 * 
	 */
	 ...
	 * <p>
	 *  设置用于读取脚本资源的编码<p>常规资源的默认值为"UTF-8"{@code null}值表示平台默认值
	 * 
	 */
