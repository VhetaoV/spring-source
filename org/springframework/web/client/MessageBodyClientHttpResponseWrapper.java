 ...
 *
 * <p>
 *  实现{@link ClientHttpResponse},不仅可以检查响应是否具有消息体,还可以通过实际读取输入流来确定其长度为0(即为空)
 * 
 * 
 * @author Brian Clozel
 * @since 4.1.5
...
class MessageBodyClientHttpResponseWrapper implements ClientHttpResponse {
	 ...
	 * </ul>
	 * <p>
	 * 指示响应是否有消息正文<p>实现返回{@code false}：
	 * <ul>
	 *  {@code 1XX},{@code 204}或{@code 304} </li> <li> {@code 0} {@code Content-Length}标头的回覆状态</li>
	 * </ul>
	 * 
	 ...
	 * </ul>
	 * <p>
	 *  指示响应是否具有空消息正文<p>实现尝试读取响应流的第一个字节：
	 * <ul>
	 * 
