 ...
 *
 * <p>
 *  特殊的JSF {@code ELResolver}将Spring {@code WebApplicationContext}实例暴露在名为"webApplicationContext"的变量下
 * 
 * <p>与{@link SpringBeanFacesELResolver}相反,此ELResolver变体<i>不会将JSF变量名称解析为Spring bean名称,而是以特殊名称公开Spring的根W
 * ebApplicationContext <i>本身</i> ,并且能够解析在该应用程序上下文中的Spring定义的bean的"webApplicationContextmySpringManagedB
 * usinessObject"取消引用。
 * 
 *  <p>在您的{@code faces-configxml}文件中配置此解析器,如下所示：
 * 
 * <pre class="code">
 * &lt;application>
 * 
...
public class WebApplicationContextFacesELResolver extends ELResolver {
	 ...
	 * <p>
	 *  暴露的WebApplicationContext变量的名称："webApplicationContext"
	 * 
	 * 
