...
final class HierarchicalUriComponents extends UriComponents {
	 ...
	 * <p>
	 *  Package-private构造函数所有参数都是可选的,可以是{@code null}
	 * 
	 * 
	 ...
	 * <p>
	 *  使用给定组件和给定选项指定的规则将给定的源编码为编码的字符串
	 * 
	 * 
	 ...
	 * <p>
	 *  验证所有URI组件,以确定它们是否包含任何非法字符,如果是,则抛出{@code IllegalArgumentException}
	 * 
	 * 
	 ...
	 * <p>
	 *  从这个{@code UriComponents}实例返回一个URI字符串
	 * 
	 */
	@Override
	 ...
	 * <p>
	 *  用于标识每个URI组件允许的字符的枚举<p>包含指定给定字符在特定URI组件中是否有效的方法
	 * 
	 * 
