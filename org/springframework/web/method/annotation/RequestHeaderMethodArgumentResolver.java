 ...
 *
 * <p>
 *  解决使用{@code @RequestHeader}注释的方法参数,{@link Map}参数除外{@link RequestHeaderMapMethodArgumentResolver}有关{@code @RequestHeader}
 * 注释的{@link Map}参数的详细信息。
 * 
 * <p>一个{@code @RequestHeader}是一个从请求头解析的命名值它有一个必需的标志和一个默认值,当请求头不存在
 * 
 * 
