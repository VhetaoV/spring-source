 ...
 *
 * <p>
 *  处理方法返回值通过委托到已注册的{@link HandlerMethodReturnValueHandler}的列表以前解决的返回类型被缓存以便更快的查找
 * 
 * 
...
public class HandlerMethodReturnValueHandlerComposite implements AsyncHandlerMethodReturnValueHandler {
	 ...
	 * <p>
	 *  是否由任何已注册的{@link HandlerMethodReturnValueHandler}支持给定的{@linkplain MethodParameter方法返回类型}
	 * 
	 */
	@Override
	 ...
	 * <p>
	 *  迭代已注册的{@link HandlerMethodReturnValueHandler},并调用支持它的
	 * 
	 * 
