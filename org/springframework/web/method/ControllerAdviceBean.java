 ...
 *
 * <p>
 *  封装关于{@linkplain ControllerAdvice @ControllerAdvice} Spring管理的bean的信息,而不一定要求实例化
 * 
 * <p>可以使用{@link #findAnnotatedBeans(ApplicationContext)}方法来发现这样的bean但是,可以从任何对象创建{@code ControllerAdviceBean}
 * ,包括没有{@code @ControllerAdvice}的对象。
 * 
 * 
...
public class ControllerAdviceBean implements Ordered {
	 ...
	 * <p>
	 *  使用给定的bean名称创建一个{@code ControllerAdviceBean}
	 * 
	 * 
	 ...
	 * <p>
	 *  返回从{@link ControllerAdvice}注释提取的订单值,否则返回{@link有序#LOWEST_PRECEDENCE}
	 * 
	 */
	@Override
	public int getOrder() {
	 ...
	 * <p>
	 *  返回包含的bean的类型<p>如果bean类型是CGLIB生成的类,则返回原始用户定义的类
	 * 
	 */
	 ...
	 * <p>
	 *  如果需要,通过BeanFactory解析bean名称返回一个bean实例
	 * 
	 */
	 ...
	 * <p>
	 * 检查给定的bean类型是否应该由{@code @ControllerAdvice}实例协助
	 * 
	 * 
	 ...
	 * <p>
	 *  在给定的ApplicationContext中查找使用{@linkplain ControllerAdvice @ControllerAdvice}注释的bean的名称,并将其包装为{@code ControllerAdviceBean}
	 * 实例。
	 */
