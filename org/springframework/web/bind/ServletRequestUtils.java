 ...
 * 
 * <p>这种方法对于简单的提交非常有用,对于命令对象的绑定请求参数将是过度的
 * 
 * 
...
public abstract class ServletRequestUtils {
	 ...
	 * <p>
	 *  获取整数参数,或{@code null}(如果不存在)如果参数值不是数字,则抛出异常
	 * 
	 * 
	 ...
	 * <p>
	 *  获取一个int参数,具有回退值不要抛出异常可以将一个区分值作为默认值启用检查是否提供
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * <p>
	 *  获取一个int参数,抛出一个异常,如果没有找到或不是一个数字
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * <p>
	 *  获取一个int参数数组,如果没有找到异常,或者一个不是数字,则抛出异常
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter with multiple possible values
	 ...
	 * Throws an exception if it the parameter value isn't a number.
	 * <p>
	 *  获取长参数,或{@code null}(如果不存在)如果参数值不是数字,则抛出异常
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * Can pass a distinguished value as default to enable checks of whether it was supplied.
	 * <p>
	 * 获取一个长参数,具有回退值不要抛出异常可以将默认值作为默认值传递,以检查是否提供
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * <p>
	 *  获取一个很长的参数,抛出一个异常,如果没有找到或不是一个数字
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * <p>
	 *  获取一个长参数的数组,抛出异常,如果没有找到或一个不是一个数字
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter with multiple possible values
	 ...
	 * Throws an exception if it the parameter value isn't a number.
	 * <p>
	 *  获取浮点参数,或{@code null}(如果不存在)如果参数值不是数字,则抛出异常
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * Can pass a distinguished value as default to enable checks of whether it was supplied.
	 * <p>
	 *  获取一个带有回退值的float参数从不抛出异常可以将一个区分值作为默认值启用检查是否提供
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * <p>
	 * 获取一个float参数,抛出一个异常,如果没有找到或不是一个数字
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * <p>
	 *  获取一个float参数的数组,如果没有找到或抛出一个异常,则抛出异常
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter with multiple possible values
	 ...
	 * Throws an exception if it the parameter value isn't a number.
	 * <p>
	 *  获取Double参数,或{@code null}(如果不存在)如果参数值不是数字,则抛出异常
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * Can pass a distinguished value as default to enable checks of whether it was supplied.
	 * <p>
	 *  获取一个双参数,具有回退值不要抛出异常可以将一个区别值作为默认值来启用是否提供了检查
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * <p>
	 *  获取一个double参数的数组,如果没有找到,返回一个空数组
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter with multiple possible values
	 ...
	 * <p>
	 *  获取一个double参数,抛出异常,如果没有找到或不是一个数字
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * <p>
	 *  获取一个double参数的数组,如果没有找到或抛出一个异常,则抛出异常
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter with multiple possible values
	 ...
	 * <p>
	 * 获取一个布尔参数,如果不存在,则返回{@code null}如果参数值不是布尔值,则抛出异常<p>接受"true","on","yes"(任何情况)和"1"作为真值;将其他非空值视为假(即宽松地解析)。
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * treats every other non-empty value as false (i.e. parses leniently).
	 * <p>
	 *  获取一个布尔参数,使用回退值不要抛出异常可以将默认值传递给启用检查是否提供<p>接受"true","on","yes"(任何情况)和"1" "为真值;将其他非空值视为假(即宽松地解析)
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * treats every other non-empty value as false (i.e. parses leniently).
	 * <p>
	 *  获取一个布尔参数数组,如果没有找到,返回一个空数组<p>接受"true","on","yes"(任何情况)和"1"作为true值;将其他非空值视为假(即宽松地解析)
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter with multiple possible values
	 ...
	 * treats every other non-empty value as false (i.e. parses leniently).
	 * <p>
	 * 获取一个布尔参数,抛出一个异常,如果没有找到或不是一个布尔值<p>接受"true","on","yes"(任何情况)和"1"作为true值;将其他非空值视为假(即宽松地解析)
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * treats every other non-empty value as false (i.e. parses leniently).
	 * <p>
	 *  获取一个布尔参数的数组,抛出异常(如果没有找到或者不是布尔值)<p>接受"true","on","yes"(任何情况)和"1"作为true值;将其他非空值视为假(即宽松地解析)
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * <p>
	 *  获取一个String参数,或者{@code null}(如果不存在)
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
	 ...
	 * <p>
	 *  获取一个String参数,使用回退值不要抛出异常可以将一个区分值传递给默认值,以启用是否提供检查
	 * 
	 * 
	 * @param request current HTTP request
	 * @param name the name of the parameter
