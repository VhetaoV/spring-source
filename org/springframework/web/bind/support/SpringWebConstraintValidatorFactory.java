 ...
 *
 * <p>
 *  JSR-303 {@link ConstraintValidatorFactory}实现,委托给当前的Spring {@link WebApplicationContext}来创建自动连线{@link ConstraintValidator}
 * 实例。
 * 
 * <p>与{@link orgspringframeworkvalidationbeanvalidationSpringConstraintValidatorFactory}相反,此变体用于在标准{@code validationxml}
 * 文件中进行声明使用,例如与JAX-RS或JAX-WS结合使用。
 * 
