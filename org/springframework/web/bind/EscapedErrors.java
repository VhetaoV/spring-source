...
public class EscapedErrors implements Errors {
	 ...
	 * <p>
	 *  错误的包装器将自动HTML转义添加到包装的实例中,方便在HTML视图中使用可以通过RequestContext的{@code getErrors}方法轻松检索
	 * 
	 * <p>请注意,BindTag不</i>使用此类避免不必要的ObjectError实例的创建它只是转义了被复制到相应的BindStatus实例的消息和值
	 * 
	 */
