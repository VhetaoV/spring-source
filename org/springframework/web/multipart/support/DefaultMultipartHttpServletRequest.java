 ...
 *
 * <p>
 *  {@link orgspringframeworkwebmultipartMultipartHttpServletRequest}接口的默认实现提供对预先生成的参数值的管理
 * 
 * <p>由{@link orgspringframeworkwebmultipartcommonsCommonsMultipartResolver}使用
 * 
 * 
...
public class DefaultMultipartHttpServletRequest extends AbstractMultipartHttpServletRequest {
	 ...
	 * <p>
	 *  将参数名称映射为键和String数组对象作为值初始化时由子类调用
	 * 
	 */
	 ...
	 * lazily initializing it if necessary.
	 * <p>
	 *  获取多部分参数内容类型Map进行检索,如有需要,可以延迟初始化
	 * 
	 * @see #initializeMultipart()
	 */
