...
public class RequestPartServletServerHttpRequest extends ServletServerHttpRequest {
	 ...
	 * <p>
	 * 访问多部分请求的一部分的{@link ServerHttpRequest}实现如果使用{@link MultipartResolver}配置,则通过{@link MultipartFile}访问该部分;
	 * 或者如果使用Servlet 30多部分处理,则通过{@code ServletRequestgetPart}访问该部分,。
	 * 
	 * 
