 ...
 *
 * <p>
 *  MultipartHttpServletRequest接口的抽象基础实现提供对预先生成的MultipartFile实例的管理
 * 
 * 
...
public abstract class AbstractMultipartHttpServletRequest extends HttpServletRequestWrapper
	 ...
	 * <p>
	 * 将参数名称作为键和将MultipartFile对象列表设置为值的映射在初始化时由子类调用
	 * 
	 */
	 ...
	 * <p>
	 *  获取MultipartFile Map进行检索,如果需要,可以对其进行初始化
	 * 
	 * 
	 ...
	 * <p>
	 *  如果可能的话,Lazily初始化multipart请求只有在不被初始化的情况下才调用
	 */
