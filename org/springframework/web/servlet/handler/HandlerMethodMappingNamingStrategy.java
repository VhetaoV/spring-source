 ...
 *  为处理程序方法的映射分配名称的策略
 * 
 * <p>可以在{@link orgspringframeworkwebservlethandlerAbstractHandlerMethodMapping AbstractHandlerMethodMapping}
 * 上配置策略它用于为每个注册的处理程序方法的映射分配一个名称。
 * 然后可以通过{@link orgspringframeworkwebservlethandlerAbstractHandlerMethodMapping#getHandlerMethodsForMappingName(String)AbstractHandlerMethodMapping#getHandlerMethodsForMappingName}
 * 查询名称。
 * 
 * 
...
public interface HandlerMethodMappingNamingStrategy<T> {
	 ...
	 * <p>
	 *  <p>应用程序可以通过静态方法{@link orgspringframeworkwebservletmvcmethodannotationMvcUriComponentsBuilder#fromMappingName(String)MvcUriComponentsBuilder#fromMappingName}
	 * 或通过Spring标签库注册的"mvcUrl"函数在JSP中的名称来构建控制器方法的URL。
	 * 
	 * 
