 ...
 *
 * <p>
 *  Helper类从{@code HandlerMapping}获取信息,用于提供特定请求
 * 
 *  <p>提供以下方法：
 * <ul>
 * <li> {@ link #getMatchableHandlerMapping}&mdash;获取{@code HandlerMapping}以根据<li> {@ link #getCorsConfiguration}
 * &mdash检查请求匹配条件;获取请求的CORS配置。
 * </ul>
 * 
 * 
...
public class HandlerMappingIntrospector implements CorsConfigurationSource {
	 ...
	 * <p>
	 *  在给定的{@code ApplicationContext}中检测配置的{@code HandlerMapping}的构造方法,或者像{@code DispatcherServlet}中的"Dispa
	 * tcherServletproperties"。
	 * 
	 */
	 ...
	 * <p>
	 *  找到将处理给定请求的{@link HandlerMapping},并将其作为{@link MatchableHandlerMapping}返回,可用于测试请求匹配条件<p>如果匹配的HandlerMa
	 * pping不是{@link MatchableHandlerMapping}的实例, ,引发了一个IllegalStateException。
	 * 
	 * 
