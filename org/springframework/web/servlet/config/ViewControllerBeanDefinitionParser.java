 ...
 *
 * <p>
 *  解析以下MVC命名空间元素的{@link orgspringframeworkbeansfactoryxmlBeanDefinitionParser}：
 * <ul>
 *  <li> {@ code <view-controller>} <li> {@ code <redirect-view-controller>} <li> {@ code <state-controller>}
 * 。
 * </ul>
 * 
 * @author Keith Donald
