 ...
 *
 * <p>
 *  在MVC命名空间BeanDefinitionParsers中使用的方便方法
 * 
 * 
...
abstract class MvcNamespaceUtils {
	 ...
	 * <p>
	 *  为现有知名的名称添加一个别名,或者以该着名名称注册新的{@link UrlPathHelper}实例,除非已经注册
	 * 
	 * 
	 ...
	 * under that well-known name, unless already registered.
	 * <p>
	 * 在现有的知名名称中添加一个别名,或者以该着名名称注册一个{@link PathMatcher}的新实例,除非已经注册
	 * 
	 * 
	 ...
	 * <p>
	 *  注册{@link HttpRequestHandlerAdapter},除非已经注册,否则以众所周知的名义注册
	 * 
	 */
	 ...
	 * name unless already registered.
	 * <p>
	 *  注册{@link SimpleControllerHandlerAdapter},除非已经注册,否则以众所周知的名义注册
	 * 
	 */
	 ...
	 * <p>
	 *  注册{@code Map <String,CorsConfiguration>}(映射的{@code CorsConfiguration}),除非已经注册,否则可以更新bean定义(如果提供了非空的C
	 * ORS配置)。
	 * 
	 * 
