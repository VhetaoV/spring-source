 ...
 *
 * <p>
 *  提供{@code <annotation-driven />} MVC命名空间元素配置的{@link BeanDefinitionParser}
 * 
 *  <p>此类注册以下{@link HandlerMapping}：</p>
 * <ul>
 * <li> {@ link RequestMappingHandlerMapping}在0处排序,用于将请求映射到带注释控制器方法的<li> {@ link BeanNameUrlHandlerMapping}
 * ,以将URL路径映射到控制器bean名称。
 * </ul>
 * 
 *  <p> <strong>注意：</strong>其他HandlerMappings可能因使用{@code <view-controller>}或{@code <resources>} MVC命名空间元
 * 素而被注册。
 * 
 *  <p>此类注册以下{@link HandlerAdapter}：
 * <ul>
 ...
 * </ul>
 * 
 * <p>此类注册以下{@link HandlerExceptionResolver}：
 * <ul>
...
class AnnotationDrivenBeanDefinitionParser implements BeanDefinitionParser {
	 ...
	 * </ul>
	 * 
	 *  <p>此类注册一个{@link orgspringframeworkutilAntPathMatcher}和一个{@link orgspringframeworkwebutilUrlPathHelper}
	 * 以供以下功能使用：。
	 * <ul>
	 ...
	 * </ul>
	 *  请注意,可以使用{@code路径匹配} MVC命名空间元素来配置这些bean
	 * 
	 * <p>默认情况下,{@link RequestMappingHandlerAdapter}和{@link ExceptionHandlerExceptionResolver}都配置有以下实例：
	 */
