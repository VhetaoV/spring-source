 ...
 *
 * <p>
 * {@link orgspringframeworkwebservletViewResolver}的简单实现,将视图名称解释为当前应用程序上下文中的bean名称,即通常在执行的{@code DispatcherServlet}
 * 的XML文件中。
 * 
 *  <p>此解析器可以方便小型应用程序,保持所有定义范围从控制器到同一位置的视图对于较大的应用程序,{@link XmlViewResolver}将是更好的选择,因为它将XML视图bean定义分解为专用视
 * 图文件。
 * 
 * 
