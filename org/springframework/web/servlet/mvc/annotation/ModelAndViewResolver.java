 ...
 *
 * <p>
 *  用于从特定处理程序方法解析自定义返回值的SPI通常用于检测特殊返回类型,为它们解析众所周知的结果值
 * 
 * <p>典型的实现可能如下所示：
 * 
 * <pre class="code">
 *  公共类MyModelAndViewResolver实现ModelAndViewResolver {
 * 
 * 
...
public interface ModelAndViewResolver {
	 ...
	 * <p>
	 *  public ModelAndView resolveModelAndView(Method handlerMethod,Class handlerType,Object returnValue,Ex
	 * tendedModelMap implicitModel,NativeWebRequest webRequest){if(returnValue instanceof MySpecialRetValclass)){return new MySpecialRetVal(returnValue); }
