 ...
 *
 * <p>
 *  通过使用{@link HttpMessageConverter}从请求正文读取来解析方法参数值的基类
 * 
 * 
...
public abstract class AbstractMessageConverterMethodArgumentResolver implements HandlerMethodArgumentResolver {
	 ...
	 * <p>
	 *  通过{@link MediaType#sortBySpecificity(List)}返回按特定性排序的所有提供的消息转换器支持的媒体类型
	 * 
	 */
	 ...
	 * <p>
	 *  返回配置的{@link RequestBodyAdvice}和{@link RequestBodyAdvice},其中每个实例可能被包装为{@link orgspringframeworkwebmethodControllerAdviceBean ControllerAdviceBean}
	 * 。
	 * 
	 */
	 ...
	 * <p>
	 *  通过从给定的HttpInputMessage读取来创建期望参数类型的方法参数值
	 * 
	 * 
	 * @param <T> the expected type of the argument value to be created
	 ...
	 * <p>
	 *  从给定的{@link NativeWebRequest}中创建一个新的{@link HttpInputMessage}
	 * 
	 * 
	 ...
	 * <p>
	 * 验证请求部分(如果适用)<p>默认实现检查{@code @javaxvalidationValid},Spring的{@link orgspringframeworkvalidationannotationValidated}
	 * 和自定义注释,其名称以"有效"开头。
	 * 
	 * 
