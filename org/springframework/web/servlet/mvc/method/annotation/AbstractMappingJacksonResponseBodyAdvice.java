 ...
 *
 * <p>
 *  {@code ResponseBodyAdvice}实现的方便的基类,可以使用{@link AbstractJackson2HttpMessageConverter}的具体子类定制JSON序列化之前的
 * 响应。
 * 
 * 
...
public abstract class AbstractMappingJacksonResponseBodyAdvice implements ResponseBodyAdvice<Object> {
	 ...
	 * <p>
	 * 将身体包裹在{@link MappingJacksonValue}值容器中(用于提供附加的序列化说明),或者如果已经包装
	 * 
	 */
	 ...
	 * <p>
	 *  仅当转换器类型为{@code MappingJackson2HttpMessageConverter}时调用
	 */
