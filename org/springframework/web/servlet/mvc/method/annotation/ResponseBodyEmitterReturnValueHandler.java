 ...
 *
 * <p>
 *  处理程序返回值类型为{@link ResponseBodyEmitter}(以及{@code ResponseEntity <ResponseBodyEmitter>}子类)以及任何其他异步类型与{@link #getAdapterMap()注册适配器}
 * 。
 * 
 * 
...
public class ResponseBodyEmitterReturnValueHandler implements AsyncHandlerMethodReturnValueHandler {
	 ...
	 * <p>
	 * 使用{@code ResponseBodyEmitter}适配器返回地图默认情况下,地图包含一个适配器{@code ResponseBodyEmitter},简单地将返回值降低
	 * 
	 * 
	 ...
	 * <p>
	 *  适用于{@code ResponseBodyEmitter}返回值
	 * 
	 */
	 ...
	 * <p>
	 *  ResponseBodyEmitterHandler用HttpMessageConverter的
	 * 
	 */
	 ...
	 * <p>
	 *  封装以静默地忽略标题更改HttpMessageConverter的,否则会导致HttpHeaders引发异常
	 */
