 ...
 *
 * <p>
 *  解决使用@ {@ link PathVariable}注释的方法参数
 * 
 * <p>一个@ {@ link PathVariable}是一个从URI模板变量中解析的命名值它始终是必需的,并且没有默认值回退参见基类{@link orgspringframeworkwebmethodannotationAbstractNamedValueMethodArgumentResolver}
 * 以了解更多信息如何处理命名值。
 * 
 * 
