 ...
 *
 * <p>
 * 允许在其身体被读取并转换为对象之前自定义请求,并且还允许在将结果Object作为{@code @RequestBody}或{@code HttpEntity}方法参数传入控制器方法之前对其进行处理
 * 
 *  <p>可以使用{@code RequestMappingHandlerAdapter}直接注册此合同的实现,或者更可能使用{@code @ControllerAdvice}注释,在这种情况下,它们是自
 * 动检测的。
 * 
 * 
