 ...
 *
 * <p>
 *  数据绑定感知的JSP标签用于使用"{@code password}"的"{@code type}"呈现HTML"{@code input}"元素
 * 
 * 
 * @author Rob Harrop
 * @author Rick Evans
...
public class PasswordInputTag extends InputTag {
	 ...
	 * <p>
	 *  返回"{@code password}",导致渲染的HTML"{@code input}"元素具有"{@code type}"的"{@code password}"
	 * 
	 */
	@Override
	 ...
	 * <p>
	 *  如果{@link #setShowPassword(boolean)'showPassword'}属性值为{@link Boolean#TRUE true},则{@link PasswordInputTag}
	 * 仅写入它的值。
	 */
	@Override
