...
public class TagWriter {
	 ...
	 * <p>
	 * 商店{@link TagStateEntry标签状态}堆栈模型自然支持标记嵌套
	 * 
	 */
	 ...
	 * <p>
	 *  创建一个{@link TagWriter}类的新实例,该实例写入提供的{@link PageContext}
	 * 
	 * 
	 ...
	 * <p>
	 *  创建一个{@link TagWriter}类的新实例,该实例写入提供的{@link Writer}
	 * 
	 * 
	 ...
	 * <p>
	 *  使用提供的名称启动新标签将标签打开,使属性,内部文本或嵌套标签可以写入其中
	 * 
	 * 
	 * @see #endTag()
	 */
	 ...
	 * <p>
	 *  编写具有指定名称和值的HTML属性<p>确保在</strong>之前写入所有属性<strong>写入任何内部文本或嵌套标签
	 * 
	 * 
	 ...
	 * or zero length.
	 * <p>
	 *  如果提供的值不是{@code null}或零长度,则编写一个HTML属性
	 * 
	 * 
	 ...
	 * <p>
	 * 指示当前打开的标签应该被关闭并标记为块级元素<p>当您计划在当前{@link TagWriter}的上下文之外编写其他内容时很有用,
	 * 
	 */
	 ...
	 * have been written.
	 * <p>
	 *  关闭当前标签<p>如果没有写入内部文本或嵌套标签,则正确写入空标签
	 * 
	 */
	 ...
	 * have been written.
	 * <p>
	 *  关闭当前标签,允许执行完整的关闭标签<p>如果没有写入内部文本或嵌套标签,则正确地写入一个空标签
	 * 
	 * 
	 ...
	 * <p>
	 *  简单的{@link Writer}包装器,它将所有{@link IOException IOExceptions}包装在{@link JspException JspExceptions}中
	 */
