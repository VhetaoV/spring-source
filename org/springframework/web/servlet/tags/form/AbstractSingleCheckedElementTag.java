 ...
 *
 * <p>
 *  抽象基类提供了实现数据绑定感知JSP标签的常用方法,用于使用'{@code checkbox}'{@code type}'呈现单个</i> HTML'{@code input}'元素'或'{@code radio}
 * '。
 * 
 * 
...
public abstract class AbstractSingleCheckedElementTag extends AbstractCheckedElementTag {
	 ...
	 * <p>
	 *  使用配置的{@link #setValue(Object)值渲染"{@code input(radio)}"元素}如果该值与{@link #getValue绑定值}匹配,则将元素标记为已检查
	 * 
	 */
	@Override
