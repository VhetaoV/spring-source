 ...
 *
 * <p>
 *  用于使用Spring表达式语言(Spel)评估表达式的JSP标记支持由隐式变量和作用域属性组成的标准JSP评估上下文
 * 
 * 
 * @author Keith Donald
...
public class EvalTag extends HtmlEscapingAwareTag {
	 ...
	 * <p>
	 * 页面级{@link EvaluationContext}实例的{@link javaxservletjspPageContext}属性
	 * 
	 */
	 ...
	 * <p>
	 *  设置变量名称以在"默认值"下显示评估结果,以将结果呈现给当前的JspWriter
	 * 
	 */
