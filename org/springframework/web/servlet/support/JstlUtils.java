...
public abstract class JstlUtils {
	 ...
	 * <p>
	 * 检查JSTL的"javaxservletjspjstlfmtlocalizationContext"上下文参数并创建一个相应的子消息源,提供的Spring定义的MessageSource为父
	 * 
	 * 
	 ...
	 * <p>
	 *  使用Spring的区域设置和MessageSource来显示JSTL特定的请求属性,指定JSTL格式和消息标签的区域设置和资源包
	 * 
	 * 
	 ...
	 * <p>
	 *  Spring特定的LocalizationContext适配器,它将会话范围的JSTL LocalizationContext / Locale属性与本地Spring请求上下文
	 */
