 ...
 *
 * <p>
 *  {@code @ApplicationScope}是其生命周期与当前Web应用程序绑定的组件的{@link Scope @Scope}的专业化
 * 
 * <p>具体来说,{@code @ApplicationScope}是一个<em>组合注释</em>,作为{@code @Scope("application")}的快捷方式,默认{@link #proxyMode}
 * 设置为{@link ScopedProxyMode#TARGET_CLASS TARGET_CLASS}。
 * 
 * 
 * @author Sam Brannen
 * @since 4.3
...
public @interface ApplicationScope {
	 ...
	 * <p>
	 *  <p> {@ code @ApplicationScope}可以用作元注释来创建自定义组合注释
	 * 
	 */
