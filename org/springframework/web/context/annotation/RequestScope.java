 ...
 *
 * <p>
 *  {@code @RequestScope}是其生命周期与当前Web请求绑定的组件的{@link Scope @Scope}的专业化
 * 
 * <p>具体来说,{@code @RequestScope}是一个<em>组合注释</em>,作为{@code @Scope("request")}的快捷方式,默认{@link #proxyMode}设置
...
public @interface RequestScope {
	 ...
	 * <p>
	 *  <p> {@ code @RequestScope}可以用作元注释来创建自定义组合注释
	 * 
	 */
