 ...
 *
 * <p>
 *  摘要{@link Scope}实现,从当前线程绑定的{@link RequestAttributes}对象中的特定范围读取
 * 
 * <p>子类只需要实现{@link #getScope()}来指示这个类,{@link RequestAttributes}范围可以从
 * 
 *  <p>子类可能希望覆盖{@link #get}和{@link #remove}方法,以将呼叫周围的同步添加回此超级类
 * 
 * @author Rod Johnson
