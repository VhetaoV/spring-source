 ...
 *
 * <p>
 *  用于JSF的{@link RequestAttributes}适配器{@link javaxfacescontextFacesContext}在JSF环境中用作默认值,将当前的FacesContext
 * 。
 * 
 * <p> <b>注意：</b>与{@link ServletRequestAttributes}相反,此变体不支持对作用域属性的销毁回调,也不适用于请求范围或会话范围你依赖这样的隐式破坏回调,考虑在你的{@code webxml}
 * 中定义一个Spring {@link RequestContextListener}。
 * 
