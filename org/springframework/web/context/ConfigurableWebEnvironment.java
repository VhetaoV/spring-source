...
public interface ConfigurableWebEnvironment extends ConfigurableEnvironment {
	 ...
	 * <p>
	 * {@link ConfigurableEnvironment}的专业化允许在{@link ServletContext}和(可选){@link ServletConfig}变得可用的最早时间初始化与se
	 * rvlet相关的{@link orgspringframeworkcoreenvPropertySource}对象。
	 * 
	 * 
