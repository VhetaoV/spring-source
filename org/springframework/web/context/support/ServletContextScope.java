 ...
 *
 * <p>
 *  {@link Scope}包装器,用于ServletContext,即用于全局Web应用程序属性
 * 
 * <p>这与传统的Spring单例不同之处在于它暴露了ServletContext中的属性当整个应用程序关闭时,这些属性将被破坏,这可能早于或晚于关闭包含的Spring ApplicationContex
 * t。
 * 
 *  <p>相关联的销毁机制依赖于{@code webxml}中注册的{@link orgspringframeworkwebcontextContextCleanupListener}注意,{@link orgspringframeworkwebcontextContextLoaderListener}
 * 包含ContextCleanupListener的功能。
 * 
 *  <p>此范围作为默认范围注册为{@link orgspringframeworkwebcontextWebApplicationContext#SCOPE_APPLICATION"application"}
 * 
