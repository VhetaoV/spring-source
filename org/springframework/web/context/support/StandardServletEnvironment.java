 ...
 *
 * <p>
 *  {@link环境}实现由{@code Servlet}的Web应用程序使用所有与Web相关(基于servlet的){@code ApplicationContext}类默认初始化一个实例
 * 
 * <p>提供{@code ServletConfig},{@code ServletContext}和基于JNDI的{@link PropertySource}实例有关详细信息,请参阅{@link #customizePropertySources}
 * 方法文档。
 * 
 * 
 * @author Chris Beams
...
public class StandardServletEnvironment extends StandardEnvironment implements ConfigurableWebEnvironment {
	 ...
	 * <p>
	 *  使用由超类提供的属性源以及适用于基于标准servlet的环境来定制属性源集合：
	 * <ul>
	 *  <li> {@ value #SERVLET_CONFIG_PROPERTY_SOURCE_NAME} <li> {@ value #SERVLET_CONTEXT_PROPERTY_SOURCE_NAME}
	 *  <li> {@ value #JNDI_PROPERTY_SOURCE_NAME}。
	 * </ul>
	 * <p>在{@value #SERVLET_CONFIG_PROPERTY_SOURCE_NAME}中显示的属性将优先于{@value #SERVLET_CONTEXT_PROPERTY_SOURCE_NAME}
	 * 
