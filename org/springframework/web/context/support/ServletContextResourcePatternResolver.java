 ...
 *
 * <p>
 * ServletContext感知的{@link PathMatchingResourcePatternResolver}子类,能够通过{@link ServletContext#getResourcePaths}
 * 在Web应用程序根目录下找到匹配的资源回到超类文件系统检查其他资源。
 * 
 * 
...
public class ServletContextResourcePatternResolver extends PathMatchingResourcePatternResolver {
	 ...
	 * <p>
	 *  覆盖的版本检查ServletContextResource并使用{@code ServletContextgetResourcePaths}在Web应用程序根目录下找到匹配的资源在其他资源的情况下,委
	 * 托给超类版本。
	 * 
	 * 
	 ...
	 * <p>
	 *  递归地检索与给定模式匹配的ServletContextResources,将它们添加到给定的结果集中
	 * 
	 * 
