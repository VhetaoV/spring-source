...
public class ForwardedHeaderFilter extends OncePerRequestFilter {
	...
	private static class ForwardedHeaderRequestWrapper extends HttpServletRequestWrapper {
		 ...
		 * <p>
		 * 过滤器包装请求,以覆盖其{@link HttpServletRequest#getServerName()getServerName()},{@link HttpServletRequest#getServerPort()getServerPort()}
		 * ,{@link HttpServletRequest#getScheme()getScheme()}) {@link HttpServletRequest#isSecure()isSecure()}具有
		 * 从"转发"或"X-Forwarded- *"头派生的值的方法实际上,包装的请求反映了客户端发起的协议和地址。
		 * 
		 */
