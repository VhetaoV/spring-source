 ...
 *
 * <p>
 *  在Guava {@link comgooglecommoncacheCache}实例之上的Spring {@link orgspringframeworkcacheCache}适配器实现
 * 
...
public class GuavaCache extends AbstractValueAdaptingCache {
	 ...
	 * <p>
	 * 使用指定的名称和给定的内部{@link comgooglecommoncacheCache}创建{@link GuavaCache}实例以使用
	 * 
	 * 
