...
public abstract class CacheOperation implements BasicOperation {
	 ...
	 * {@link #equals}.
	 * <p>
	 * 返回此高速缓存操作的标识描述<p>在对象构造期间调用{@link Builder#getOperationDescription()}生成返回值此方法用于{@link #hashCode}和{@link #equals}
	 * 。
	 * 
	 * 
	...
	public abstract static class Builder {
		 ...
		 * <p>
		 *  返回此缓存操作的标识描述<p>可用于子类,以包含在其{@code toString()}结果中
		 */
