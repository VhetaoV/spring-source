 ...
 *
 * <p>
 *  {@link FactoryBean}用于JCache {@link javaxcacheCacheManager},通过标准的JCache {@link javaxcacheCaching}类获取一
 * 个预定义的CacheManager。
 * 
...
public class JCacheManagerFactoryBean
	 ...
	 * <p>
	 *  指定所需CacheManager的URI默认值为{@code null}(即JCache的默认值)
	 * 
	 */
	 ...
	 * <p>
	 *  指定要创建的CacheManager的属性默认值为{@code null}(即不应用特殊属性)
	 * 
