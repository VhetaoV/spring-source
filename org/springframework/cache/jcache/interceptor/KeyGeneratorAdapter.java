...
class KeyGeneratorAdapter implements KeyGenerator {
	 ...
	 * <p>
	 *  使用给定的{@link KeyGenerator}创建一个实例,以便根据规范处理{@link javaxcacheannotationCacheKey}和{@link javaxcacheannotationCacheValue}
	 * 。
	 * 
	 */
	 ...
	 * <p>
	 *  创建一个用于包装指定的{@link javaxcacheannotationCacheKeyGenerator}的实例
	 * 
	 */
	 ...
	 * <p>
	 *  返回目标密钥生成器以{@link KeyGenerator}或{@link CacheKeyGenerator}的形式使用,
	 */
