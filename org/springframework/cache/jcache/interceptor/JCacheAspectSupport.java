 ...
 * 
 * <p>使用Spring缓存抽象用于与缓存相关的操作不需要JSR-107 {@link javaxcacheCache}或{@link javaxcacheCacheManager}来处理标准的JSR-1
 * 07缓存注释。
 * 
 *  <p> {@link JCacheOperationSource}用于确定缓存操作
 * 
 *  <p>如果缓存方面的{@code JCacheOperationSource}是可序列化的,则缓存方面是可序列化的
 * 
