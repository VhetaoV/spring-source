 ...
 *
 * <p>
 *  解析Spring的{@link缓存},{@link Cacheable},{@link CacheEvict}和{@link CachePut}注释的策略实现
 * 
 * 
 * @author Costin Leau
...
public class SpringCacheAnnotationParser implements CacheAnnotationParser, Serializable {
	 ...
	 * <p>
	 * 验证指定的{@link CacheOperation} <p>如果操作的状态无效,则抛出{@link IllegalStateException}因为默认值可能有多个来源,这样可以确保操作在返回之前处于
	 * 正确的状态。
	 * 
	 * 
	...
	static class DefaultCacheConfig {
		 ...
		 * <p>
		 *  将默认值应用于指定的{@link CacheOperationBuilder}
		 * 
