 ...
 *
 * <p>
 *  根据导入{@code @Configuration}类的{@link EnableCaching#mode}的值,选择应使用{@link AbstractCachingConfiguration}的实
 * 现。
 * 
 * 检测JSR-107的存在并相应地启用JCache支持
 * 
 * 
 * @author Chris Beams
...
public class CachingConfigurationSelector extends AdviceModeImportSelector<EnableCaching> {
	 ...
	 * <p>
	 *  如果{@link AdviceMode}设置为{@link AdviceMode#PROXY} <p>,请返回导入使用<p>如果可用,请添加必要的JSR-107导入
	 * 
	 */
	 ...
	 * <p>Take care of adding the necessary JSR-107 import if it is available.
	 * <p>
	 *  如果{@link AdviceMode}设置为{@link AdviceMode#ASPECTJ} <p>,则返回要使用的导入。如果可用,请注意添加必要的JSR-107导入
	 */
