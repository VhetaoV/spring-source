 ...
 *
 * <p>
 *  用于访问与SiMP会话关联的属性的包装类(例如WebSocket会话)
 * 
 * 
...
public class SimpAttributes {
	 ...
	 * <p>
	 *  删除给定名称的属性(如果存在)<p>还删除指定属性的注册的销毁回调(如果有的话)但是它不执行</i>回调假定已删除对象将在适当的时候继续被独立使用和销毁
	 * 
	 * 
	 * @param name the name of the attribute
	 */
	 ...
	 * <p>
	 * 从给定的消息中提取SiMP会话属性,并将其包装在{@link SimpAttributes}实例中
	 * 
