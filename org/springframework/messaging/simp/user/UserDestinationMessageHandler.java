 ...
 *
 * <p>
 * 提供对发送到"用户"目的地的消息的支持,将目的地转换为一个或多个用户特定的目的地,然后使用提供的消息传递模板发送具有更新的目标目的地的消息
 * <p>
 *  有关详细信息和示例,请参阅{@link UserDestinationResolver}
 * 
 * 
