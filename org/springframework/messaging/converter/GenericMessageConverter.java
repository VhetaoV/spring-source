 ...
 *
 * <p>
 *  {@link SimpleMessageConverter}的扩展名,它使用{@link ConversionService}将邮件的有效内容转换为请求的类型
 * 
 * <p>如果转换服务无法从有效载荷类型转换为请求的类型,则返回{@code null}
 * 
 * 
...
public class GenericMessageConverter extends SimpleMessageConverter {
	 ...
	 * <p>
	 *  使用默认{@link ConversionService}创建新实例
	 * 
	 */
	 ...
	 * <p>
	 *  使用给定的{@link ConversionService}创建一个新的实例
	 */
