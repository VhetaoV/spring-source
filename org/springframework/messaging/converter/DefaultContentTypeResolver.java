 ...
 *
 * <p>
 *  检查{@link MessageHeaders#CONTENT_TYPE}标题或返回到默认值的默认{@link ContentTypeResolver}
 * 
 * <p>头值预计是可以解析成{@code MimeType}的{@link orgspringframeworkutilMimeType}或{@code String}
 * 
 * 
...
public class DefaultContentTypeResolver implements ContentTypeResolver {
	 ...
	 * <p>
	 *  设置当没有{@link MessageHeaders#CONTENT_TYPE}标题时使用的默认MIME类型<p>此属性没有默认值
	 * 
	 */
	 ...
	 * <p>
	 *  如果没有{@link MessageHeaders#CONTENT_TYPE}头,则返回默认的MIME类型
	 */
