 ...
 *
 * <p>
 *  基于Reactor项目的TCP客户端支持的{@link orgspringframeworkmessagingtcpTcpOperations}的实现
 * 
 * 
...
public class Reactor11TcpClient<P> implements TcpOperations<P> {
	 ...
	 *
	 * <p>
	 * 一个构造函数,它使用{@link reactoreventdispatchSynchronousDispatcher}创建一个{@link reactornetnettcpnettytcpClient}
	 * ,这是因为Netty线程处理了网络I / O。
	 * 
	 *  <p>另请参见构造函数接受预配置的Reactor {@link reactornettcpTcpClient}
	 * 
	 * 
	 ...
	 *
	 * <p>
	 *  具有预配置{@link reactornettcpTcpClient}的构造函数
	 * 
	 *  <p> <strong>注意：</strong>如果客户端配置了线程创建调度程序,则负责关闭客户端配置的{@link reactorcore环境}实例
	 * 
	 * 
	 ...
	 * not needed.
	 * <p>
	 *  一个强制使用SynchronousDispatcher的ConfigurationReader
	 * 
	 */
