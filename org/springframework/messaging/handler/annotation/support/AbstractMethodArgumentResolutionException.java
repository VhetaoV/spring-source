 ...
 *
 * <p>
 *  调用{@link orgspringframeworkmessaginghandlerinvocationHandlerMethodArgumentResolver}导致的异常的基类
 * 
 * 
...
public abstract class AbstractMethodArgumentResolutionException extends MessagingException {
	 ...
	 * <p>
	 *  创建一个新的实例,提供无效的{@code MethodParameter}
	 * 
	 */
	 ...
	 * <p>
	 * 创建一个新的实例,提供无效的{@code MethodParameter}和一个准备的描述子类应该在{@link #getMethodParamMessage(orgspringframeworkcoreMethodParameter)}
	 * 的帮助下添加描述。
	 * 
	 */
