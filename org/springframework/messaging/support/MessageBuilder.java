 ...
 *
 * <p>
 *  用于创建{@link GenericMessage}(或{@link ErrorMessage})的构建器,如果有效负载类型为{@link Throwable})
 * 
 * 
...
public final class MessageBuilder<T> {
	 ...
	 * <p>
	 *  通过提供{@code MessageHeaderAccessor}来设置要使用的消息头
	 * 
	 * 
	 ...
	 * <p>
	 * 设置给定标题名称的值如果提供的值为{@code null},标题将被删除
	 * 
	 */
	 ...
	 * <p>
	 *  删除通过'headerPatterns'数组提供的所有头像顾名思义,数组可能包含标题名称的简单匹配模式支持的模式样式有："xxx *","* xxx","* xxx *"和"xxx * yyy"
	 * 
	 */
	 ...
	 * <p>
	 *  从提供的映射中复制名称 - 值对此操作将覆盖任何现有值使用{{@link #copyHeadersIfAbsent(Map)}避免覆盖值请注意,'id'和'timestamp'头值绝不会被覆盖
	 * 
	 */
	 ...
	 * <p>
	 * 从提供的地图复制名称/值对此操作将<em>不</em>覆盖任何现有值
	 * 
	 */
	 ...
	 * <p>
	 *  创建一个新的{@link Message}实例的构建器,预先填充所有从提供的消息复制的头文件。提供的消息的有效负载也将用作新消息的有效负载
	 * 
	 * 
	 ...
	 * <p>
	 *  用于创建具有给定有效负载的消息的快捷工厂方法和{@code MessageHeaders} <p> <strong>注意：</strong>给定的{@code MessageHeaders}实例直接用
	 * 于新消息,即不是复制。
	 * 
