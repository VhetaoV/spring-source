 ...
 *
 * <p>
 *  向每个订阅者发送消息的{@link SubscribableChannel}
 * 
 * 
 * @author Phillip Webb
...
public class ExecutorSubscribableChannel extends AbstractSubscribableChannel {
	 ...
	 * <p>
	 *  创建一个新的{@link ExecutorSubscribableChannel}实例,消息将在调用者线程中发送
	 * 
	 */
	 ...
	 * <p>
	 * 创建一个新的{@link ExecutorSubscribableChannel}实例,消息将通过指定的执行者发送
	 * 
	 * 
	 ...
	 * <p>
	 *  用ExecutorChannelInterceptor调用一个MessageHandler
	 */
