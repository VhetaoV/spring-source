 ...
 *
 * <p>
 *  为{@link Jaxb2Marshaller}提供帮助班,为班级标记了JAXB2注释
 * 
 * 
...
class ClassPathJaxb2TypeScanner {
	 ...
	 * <p>
	 * private static final TypeFilter [] JAXB2_TYPE_FILTERS = new TypeFilter [] {new AnnotationTypeFilter(XmlRootElementclass,false),新的AnnotationTypeFilter(XmlTypeclass,false),新的AnnotationTypeFilter(XmlSeeAlsoclass,false),新的AnnotationTypeFilter(XmlEnumclass,false),新的AnnotationTypeFilter(XmlRegistryclass,假)}
	 * ;。
	 * 
	 *  private final ResourcePatternResolver resourcePatternResolver;
	 * 
