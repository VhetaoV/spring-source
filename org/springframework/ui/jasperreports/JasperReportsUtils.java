 ...
 *
 * <p>
 *  使用JasperReports的实用方法提供了一组用于生成CSV,HTML,PDF和XLS格式的报告的便利方法
 * 
 * <p> <b>此类与传统的JasperReports版本兼容,直到2x </b>因此,它继续使用2014年初已被弃用的{@link netsfjasperreportsengineJRExporter}
 *  API。
 * 
 * 
 * @author Rob Harrop
...
public abstract class JasperReportsUtils {
	 ...
	 * <p>
	 *  将给定的报告数据值转换为{@code JRDataSource} <p>在默认实现中,检测到{@code JRDataSource},{@code javautilCollection}或对象数组。
	 * 后者转换为{@code JRBeanCollectionDataSource}或{ @code JRBeanArrayDataSource}。
	 * 
	 * 
	 ...
	 * <p>
	 *  使用提供的{@code JRAbstractExporter}实例渲染提供的{@code JasperPrint}实例,并将结果写入提供的{@code Writer} <p>确保您提供的{@code JRAbstractExporter}
	 * 实现能够写入一个{@code Writer}。
	 * 
	 * 
	 ...
	 * <p>
	 * 使用提供的{@code JRAbstractExporter}实例渲染提供的{@code JasperPrint}实例,并将结果写入提供的{@code OutputStream} <p>确保您提供的{@code JRAbstractExporter}
	 * 实现能够写入一个{@code OutputStream}。
	 * 
	 * 
	 * @param exporter the {@code JRAbstractExporter} to use to render the report
	 * @param print the {@code JasperPrint} instance to render
	 ...
	 * <p>
	 *  使用提供的报告数据以CSV格式呈现报告将结果写入提供的{@code Writer}
	 * 
	 * 
	 ...
	 * Writes the results to the supplied {@code Writer}.
	 * <p>
	 *  使用提供的报告数据以HTML格式呈现报告将结果写入提供的{@code Writer}
	 * 
	 * 
	 * @param report the {@code JasperReport} instance to render
	 * @param parameters the parameters to use for rendering
	 ...
	 * <p>
	 * 使用提供的报告数据以PDF格式呈现报告将结果写入提供的{@code OutputStream}
	 * 
	 * 
	 * @param report the {@code JasperReport} instance to render
	 * @param parameters the parameters to use for rendering
	 ...
	 * Writes the results to the supplied {@code OutputStream}.
	 * <p>
	 *  使用提供的报告数据以XLS格式呈现报告将结果写入提供的{@code OutputStream}
	 * 
	 * 
	 * @param report the {@code JasperReport} instance to render
	 * @param parameters the parameters to use for rendering
