 ...
 *
 * <p>
 *  Velocity ResourceLoader适配器,通过Spring ResourceLoader加载,由VelocityEngineFactory用于任何资源加载程序路径,无法解析为{@code javaioFile}
 * 。
 * 
 * <p>请注意,此加载程序不允许进行修改检测：将Velocity的默认FileResourceLoader用于{@code javaioFile}资源
 * 
