 ...
 *
 * <p>
 * 配置VelocityEngine并将其提供为bean引用的工厂bean此bean适用于应用程序代码中Velocity的任何类型的使用,例如用于生成电子邮件内容对于Web视图,VelocityConfig
 * urer用于为视图设置VelocityEngine。
 * 
 *  <p>使用这个类的最简单的方法是指定一个"resourceLoaderPath";您不需要任何进一步的配置,例如,在Web应用程序上下文中：
 * 
 *  <pre class ="code">&lt; bean id ="velocityEngine"class ="orgspringframeworkuivelocityVelocityEngineF
 * 
