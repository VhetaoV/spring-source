 ...
 *  拦截一个新物体的建造
 * 
 * <p>用户应该实现{@link #construct(ConstructorInvocation)}方法来修改原始行为例如,以下类实现单例拦截器(只允许拦截的类的唯一实例)：
 * 
 * <pre class=code>
 *  DebuggingInterceptor类实现了ConstructorInterceptor {Object instance = null;
 * 
 * 
 * @author Rod Johnson
 */
public interface ConstructorInterceptor extends Interceptor  {
	 ...
	 * <p>
	 *  Object construct(ConstructorInvocation i)throws Throwable {if(instance == null){return instance = iproceed(); }
	 *  else {throw new Exception("singleton does not allow multiple instance"); }}}。
	 * </pre>
	 * 
	 * 
